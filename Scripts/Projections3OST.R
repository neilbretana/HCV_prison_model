...
pNewCasesOSTSumA <- data.frame(y6=NA, y7=NA, y8=NA, y9=NA, y10=NA, y11=NA, y12=NA, y13=NA, y14=NA, y15=NA, y16=NA, y17=NA, y18=NA, y19=NA, y20=NA, y21=NA, y22=NA, y23=NA, y24=NA, y25=NA, y26=NA, y27=NA, y28=NA, y29=NA, y30=NA)[numeric(0), ]
...
pTotalOSTSumA <- data.frame(y6=NA, y7=NA, y8=NA, y9=NA, y10=NA, y11=NA, y12=NA, y13=NA, y14=NA, y15=NA, y16=NA, y17=NA, y18=NA, y19=NA, y20=NA, y21=NA, y22=NA, y23=NA, y24=NA, y25=NA, y26=NA, y27=NA, y28=NA, y29=NA, y30=NA)[numeric(0), ]
...
pTotal <- data.frame(y06=NA, y07=NA, y08=NA, y09=NA, y10=NA, y11=NA, y12=NA, y13=NA, y14=NA, y15=NA, y16=NA, y17=NA, y18=NA)[numeric(0), ]
pHCVantibody <- data.frame(y06=NA, y07=NA, y08=NA, y09=NA, y10=NA, y11=NA, y12=NA, y13=NA, y14=NA, y15=NA, y16=NA, y17=NA, y18=NA)[numeric(0), ]
pHCVchronic <- data.frame(y06=NA, y07=NA, y08=NA, y09=NA, y10=NA, y11=NA, y12=NA, y13=NA, y14=NA, y15=NA, y16=NA, y17=NA, y18=NA)[numeric(0), ]
...
pNewCasesOSTSumB <- data.frame(y6=NA, y7=NA, y8=NA, y9=NA, y10=NA, y11=NA, y12=NA, y13=NA, y14=NA, y15=NA, y16=NA, y17=NA, y18=NA, y19=NA, y20=NA, y21=NA, y22=NA, y23=NA, y24=NA, y25=NA, y26=NA, y27=NA, y28=NA, y29=NA, y30=NA)[numeric(0), ]
...
pTotalOSTSumB <- data.frame(y6=NA, y7=NA, y8=NA, y9=NA, y10=NA, y11=NA, y12=NA, y13=NA, y14=NA, y15=NA, y16=NA, y17=NA, y18=NA, y19=NA, y20=NA, y21=NA, y22=NA, y23=NA, y24=NA, y25=NA, y26=NA, y27=NA, y28=NA, y29=NA, y30=NA)[numeric(0), ]
...
pNewCasesOSTSumC <- data.frame(y6=NA, y7=NA, y8=NA, y9=NA, y10=NA, y11=NA, y12=NA, y13=NA, y14=NA, y15=NA, y16=NA, y17=NA, y18=NA, y19=NA, y20=NA, y21=NA, y22=NA, y23=NA, y24=NA, y25=NA, y26=NA, y27=NA, y28=NA, y29=NA, y30=NA)[numeric(0), ]
...
pTotalOSTSumC <- data.frame(y6=NA, y7=NA, y8=NA, y9=NA, y10=NA, y11=NA, y12=NA, y13=NA, y14=NA, y15=NA, y16=NA, y17=NA, y18=NA, y19=NA, y20=NA, y21=NA, y22=NA, y23=NA, y24=NA, y25=NA, y26=NA, y27=NA, y28=NA, y29=NA, y30=NA)[numeric(0), ]
...
for (var in 1:10)
{
  ...
  pTotalTmp <- data.frame(y06=NA, y07=NA, y08=NA, y09=NA, y10=NA, y11=NA, y12=NA, y13=NA, y14=NA, y15=NA, y16=NA, y17=NA, y18=NA)[numeric(0), ]
  pTotalTmp[1,] <- 0
  ...
  pTotalTmp$y17[1] <- mean(Y12$TotalPrisonPop)
  pTotalTmp$y18[1] <- mean(Y13$TotalPrisonPop)
  pTotal <- rbind(pTotal, pTotalTmp)
  
  ptHCVaTmp <- data.frame(y06=NA, y07=NA, y08=NA, y09=NA, y10=NA, y11=NA, y12=NA, y13=NA, y14=NA, y15=NA, y16=NA, y17=NA, y18=NA)[numeric(0), ]
  ptHCVaTmp[1,] <- 0
  ...
  ptHCVaTmp$y17[1] <- mean(Y12$Pmin0+Y12$Pmin1+Y12$Pmin2+Y12$Pmin4+Y12$Pmin6+Y12$Pmin7+Y12$Pmin8+Y12$Pmin10+Y12$Pmed0+Y12$Pmed1+Y12$Pmed2+Y12$Pmed4+Y12$Pmed6+Y12$Pmed7+Y12$Pmed8+Y12$Pmed10+Y12$Pmax0+Y12$Pmax1+Y12$Pmax2+Y12$Pmax4+Y12$Pmax6+Y12$Pmax7+Y12$Pmax8+Y12$Pmax10)
  ptHCVaTmp$y18[1] <- mean(Y13$Pmin0+Y13$Pmin1+Y13$Pmin2+Y13$Pmin4+Y13$Pmin6+Y13$Pmin7+Y13$Pmin8+Y13$Pmin10+Y13$Pmed0+Y13$Pmed1+Y13$Pmed2+Y13$Pmed4+Y13$Pmed6+Y13$Pmed7+Y13$Pmed8+Y13$Pmed10+Y13$Pmax0+Y13$Pmax1+Y13$Pmax2+Y13$Pmax4+Y13$Pmax6+Y13$Pmax7+Y13$Pmax8+Y13$Pmax10)
  ...
  pHCVcTmp$y17[1] <- mean(Y12$Pmin0+Y12$Pmin1+Y12$Pmin6+Y12$Pmin7+Y12$Pmed0+Y12$Pmed1+Y12$Pmed6+Y12$Pmed7+Y12$Pmax0+Y12$Pmax1+Y12$Pmax6+Y12$Pmax7)
  pHCVcTmp$y18[1] <- mean(Y13$Pmin0+Y13$Pmin1+Y13$Pmin6+Y13$Pmin7+Y13$Pmed0+Y13$Pmed1+Y13$Pmed6+Y13$Pmed7+Y13$Pmax0+Y13$Pmax1+Y13$Pmax6+Y13$Pmax7)
...
{
  #fileName <- paste("P:/SERP/Modelling/Evaluation_Modelling/HCV prison model/Results/dailyMoves", var, ".xls", sep="")
  #fileName <- paste("P:/SERP/Modelling/Evaluation_Modelling/HCV prison model/Results/outIEi_.xls", sep="")
  fileName <- paste("/Users/neilarvinbretana/Desktop/Scenarios/Testing/results/outOSTint_", var, ".xls", sep="")
  tempFile <- read.csv(fileName, sep="\t",header=TRUE)
  ...
  pNcTmp <- data.frame(y6=NA, y7=NA, y8=NA, y9=NA, y10=NA, y11=NA, y12=NA, y13=NA, y14=NA, y15=NA, y16=NA, y17=NA, y18=NA, y19=NA, y20=NA, y21=NA, y22=NA, y23=NA, y24=NA, y25=NA, y26=NA, y27=NA, y28=NA, y29=NA, y30=NA)[numeric(0), ]
  pNcTmp[1,] <- 0
  pNcTmp$y6[1] <- sum(Y6$NCbyOST)
  pNcTmp$y7[1] <- sum(Y7$NCbyOST)
  pNcTmp$y8[1] <- sum(Y8$NCbyOST)
  pNcTmp$y9[1] <- sum(Y9$NCbyOST)
  pNcTmp$y10[1] <- sum(Y10$NCbyOST)
  pNcTmp$y11[1] <- sum(Y11$NCbyOST)
  pNcTmp$y12[1] <- sum(Y12$NCbyOST)
  pNcTmp$y13[1] <- sum(Y13$NCbyOST)
  pNcTmp$y14[1] <- sum(Y14$NCbyOST)
  pNcTmp$y15[1] <- sum(Y15$NCbyOST)
  pNcTmp$y16[1] <- sum(Y16$NCbyOST)
  pNcTmp$y17[1] <- sum(Y17$NCbyOST)
  pNcTmp$y18[1] <- sum(Y18$NCbyOST)
  pNcTmp$y19[1] <- sum(Y19$NCbyOST)
  pNcTmp$y20[1] <- sum(Y20$NCbyOST)
  pNcTmp$y21[1] <- sum(Y21$NCbyOST)
  pNcTmp$y22[1] <- sum(Y22$NCbyOST)
  pNcTmp$y23[1] <- sum(Y23$NCbyOST)
  pNcTmp$y24[1] <- sum(Y24$NCbyOST)
  pNcTmp$y25[1] <- sum(Y25$NCbyOST)
  pNcTmp$y26[1] <- sum(Y26$NCbyOST)
  pNcTmp$y27[1] <- sum(Y27$NCbyOST)
  pNcTmp$y28[1] <- sum(Y28$NCbyOST)
  pNcTmp$y29[1] <- sum(Y29$NCbyOST)
  pNcTmp$y30[1] <- sum(Y30$NCbyOST)
  pNewCasesOSTSumB <- rbind(pNewCasesOSTSumB, pNcTmp)
  ...
  ptOSTTmp <- data.frame(y6=NA, y7=NA, y8=NA, y9=NA, y10=NA, y11=NA, y12=NA, y13=NA, y14=NA, y15=NA, y16=NA, y17=NA, y18=NA, y19=NA, y20=NA, y21=NA, y22=NA, y23=NA, y24=NA, y25=NA, y26=NA, y27=NA, y28=NA, y29=NA, y30=NA)[numeric(0), ]
  ptOSTTmp[1,] <- 0
  ptOSTTmp$y6[1] <- Y6$totalOST[365]
  ptOSTTmp$y7[1] <- Y7$totalOST[365]
  ptOSTTmp$y8[1] <- Y8$totalOST[365]
  ptOSTTmp$y9[1] <- Y9$totalOST[365]
  ptOSTTmp$y10[1] <- Y10$totalOST[365]
  ptOSTTmp$y11[1] <- Y11$totalOST[365]
  ptOSTTmp$y12[1] <- Y12$totalOST[365]
  ptOSTTmp$y13[1] <- Y13$totalOST[365]
  ptOSTTmp$y14[1] <- Y14$totalOST[365]
  ptOSTTmp$y15[1] <- Y15$totalOST[365]
  ptOSTTmp$y16[1] <- Y16$totalOST[365]
  ptOSTTmp$y17[1] <- Y17$totalOST[365]
  ptOSTTmp$y18[1] <- Y18$totalOST[365]
  ptOSTTmp$y19[1] <- Y19$totalOST[365]
  ptOSTTmp$y20[1] <- Y20$totalOST[365]
  ptOSTTmp$y21[1] <- Y21$totalOST[365]
  ptOSTTmp$y22[1] <- Y22$totalOST[365]
  ptOSTTmp$y23[1] <- Y23$totalOST[365]
  ptOSTTmp$y24[1] <- Y24$totalOST[365]
  ptOSTTmp$y25[1] <- Y25$totalOST[365]
  ptOSTTmp$y26[1] <- Y26$totalOST[365]
  ptOSTTmp$y27[1] <- Y27$totalOST[365]
  ptOSTTmp$y28[1] <- Y28$totalOST[365]
  ptOSTTmp$y29[1] <- Y29$totalOST[365]
  ptOSTTmp$y30[1] <- Y30$totalOST[365]
  pTotalOSTSumB <- rbind(pTotalOSTSumB, ptOSTTmp)
...
{
  #fileName <- paste("P:/SERP/Modelling/Evaluation_Modelling/HCV prison model/Results/dailyMoves", var, ".xls", sep="")
  #fileName <- paste("P:/SERP/Modelling/Evaluation_Modelling/HCV prison model/Results/outIEd9_.xls", sep="")
  fileName <- paste("/Users/neilarvinbretana/Desktop/Scenarios/Testing/results/outOSTopt_", var, ".xls", sep="")
  tempFile <- read.csv(fileName, sep="\t",header=TRUE)
  ...
  pNcTmp$y29[1] <- sum(Y29$NCbyOST)
  pNcTmp$y30[1] <- sum(Y30$NCbyOST)
  pNewCasesOSTSumC <- rbind(pNewCasesOSTSumC, pNcTmp)
  ...
  ptOSTTmp$y29[1] <- Y29$totalOST[365]
  ptOSTTmp$y30[1] <- Y30$totalOST[365]
  pTotalOSTSumC <- rbind(pTotalOSTSumC, ptOSTTmp)
...
PlotA <- ggplot(data=pop, aes(x=Year, y=Population, group=Security, col=Security, linetype=Security)) + geom_errorbar(aes(ymin=floor, ymax=ceiling), colour="black", width=.1) + geom_line(aes(linetype=Security, color=Security)) + geom_point(aes(color=Security)) + scale_linetype_manual(values=c("solid","solid","solid","twodash","dotted", "twodash","dotted","twodash", "dotted")) + scale_color_manual(values=c("#660000", "#006633", "#003366", "#C0392B", "#239B56", "#3399CC", "#2874A6")) + ylim(0, 15000) + ggtitle("B") + theme_bw() + theme(legend.position="right", text=element_text(size=15), legend.title=element_blank(), plot.title = element_text(hjust = -0.1, vjust=1), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.text.x = element_text(angle=60, hjust=1))
...
HCVA$Description <- c("DAA intermediate scenario")#c("DAA treatments retained at 1000 per year")
...
PlotA <- ggplot(data=incHCVIDU, aes(x=Year, y=IncidenceIDU, group=Description, col=Description, linetype=Description)) + geom_errorbar(aes(ymin=IncidenceFloor, ymax=IncidenceCeiling), width=.1) + geom_line(aes(linetype=Description, color=Description)) + geom_point(aes(shape=Description), size=3.5) + scale_linetype_manual(values=c("twodash", "solid", "longdash", "dotted", "dotdash")) + scale_shape_manual(values=c(15, 19, 17, 8, 4))  + ylab("HCV incidence\n among PWID") + geom_vline(xintercept=c(13), linetype="dotted") + scale_color_manual(values=c("#006633", "#660000", "#003366", "#000000", "#000000")) + ylim(0, 30) + geom_point(data=HCVEvan, mapping=aes(x=Year, y=IncidenceIDU, shape=Description), size=4) + geom_errorbar(data=HCVEvan, mapping=aes(ymin=IncidenceIDU-IncidenceIDUCI, ymax=IncidenceIDU+IncidenceIDUCI), colour="black", width=.1) + geom_point(data=HCVStopc, mapping=aes(x=Year, y=IncidenceIDU, shape=Description), size=4) + ggtitle("A") + theme_bw() + theme(legend.position="right", text=element_text(size=15), legend.title=element_blank(), plot.title = element_text(hjust = -0.05, vjust=1), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.text.x = element_text(angle = 40, hjust = 1))

PlotLegend <- ggplot(data=incHCVIDU, aes(x=Year, y=IncidenceIDU, group=Description, col=Description, linetype=Description)) + geom_errorbar(aes(ymin=IncidenceFloor, ymax=IncidenceCeiling), width=.1) + geom_line(aes(linetype=Description, color=Description)) + geom_point(aes(shape=Description), size=3.5) + scale_linetype_manual(values=c("dashed","twodash", "dotdash", "solid", "longdash", "dotted")) + scale_shape_manual(values=c(3, 15, 19, 17, 8, 4))  + ylab("HCV incidence\n among PWID") + geom_vline(xintercept=c(9, 13), linetype="dotted") + scale_color_manual(values=c("#000000", "#006633", "#660000", "#003366", "#000000", "#000000")) + ylim(0, 30) + geom_point(data=HCVEvan, mapping=aes(x=Year, y=IncidenceIDU, shape=Description), size=3.5) + geom_errorbar(data=HCVEvan, mapping=aes(ymin=IncidenceIDU-IncidenceIDUCI, ymax=IncidenceIDU+IncidenceIDUCI), colour="black", width=.1) + geom_point(data=HCVStopc, mapping=aes(x=Year, y=IncidenceIDU, shape=Description), size=3.5) + geom_point(data=HCVPrev, mapping=aes(x=Year, y=IncidenceIDU, shape=Description), size=3.5) + ggtitle("A") + theme_bw() + theme(legend.position="right", text=element_text(size=15), legend.title=element_blank(), plot.title = element_text(hjust = -0.05, vjust=1), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.text.x = element_text(angle = 40, hjust = 1))
...
#Subpops
#Subpopulation
Total <- data.frame("Population"=c(mean(pTotalB$y6), mean(pTotalB$y7), mean(pTotalB$y8), mean(pTotalB$y9), mean(pTotalB$y10), mean(pTotalB$y11), mean(pTotalB$y12), mean(pTotalB$y13), mean(pTotalB$y14), mean(pTotalB$y15), mean(pTotalB$y16), mean(pTotalB$y17), mean(pTotalB$y18), mean(pTotalB$y19), mean(pTotalB$y20), mean(pTotalB$y21), mean(pTotalB$y22), mean(pTotalB$y23), mean(pTotalB$y24), mean(pTotalB$y25), mean(pTotalB$y26), mean(pTotalB$y27), mean(pTotalB$y28), mean(pTotalB$y29), mean(pTotalB$y30)))
Total$floor <- c(min(pTotalB$y6), min(pTotalB$y7), min(pTotalB$y8), min(pTotalB$y9), min(pTotalB$y10), min(pTotalB$y11), min(pTotalB$y12), min(pTotalB$y13), min(pTotalB$y14), min(pTotalB$y15), min(pTotalB$y16), min(pTotalB$y17), min(pTotalB$y18), min(pTotalB$y19), min(pTotalB$y20), min(pTotalB$y21), min(pTotalB$y22), min(pTotalB$y23), min(pTotalB$y24), min(pTotalB$y25), min(pTotalB$y26), min(pTotalB$y27), min(pTotalB$y28), min(pTotalB$y29), min(pTotalB$y30))
Total$ceiling <- c(max(pTotalB$y6), max(pTotalB$y7), max(pTotalB$y8), max(pTotalB$y9), max(pTotalB$y10), max(pTotalB$y11), max(pTotalB$y12), max(pTotalB$y13), max(pTotalB$y14), max(pTotalB$y15), max(pTotalB$y16), max(pTotalB$y17), max(pTotalB$y18), max(pTotalB$y19), max(pTotalB$y20), max(pTotalB$y21), max(pTotalB$y22), max(pTotalB$y23), max(pTotalB$y24), max(pTotalB$y25), max(pTotalB$y26), max(pTotalB$y27), max(pTotalB$y28), max(pTotalB$y29), max(pTotalB$y30))
Total$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
TotalIDU$Description <- c("total prison population")

TotalIDU <- data.frame("Population"=c(mean(pTotalIDUB$y6), mean(pTotalIDUB$y7), mean(pTotalIDUB$y8), mean(pTotalIDUB$y9), mean(pTotalIDUB$y10), mean(pTotalIDUB$y11), mean(pTotalIDUB$y12), mean(pTotalIDUB$y13), mean(pTotalIDUB$y14), mean(pTotalIDUB$y15), mean(pTotalIDUB$y16), mean(pTotalIDUB$y17), mean(pTotalIDUB$y18), mean(pTotalIDUB$y19), mean(pTotalIDUB$y20), mean(pTotalIDUB$y21), mean(pTotalIDUB$y22), mean(pTotalIDUB$y23), mean(pTotalIDUB$y24), mean(pTotalIDUB$y25), mean(pTotalIDUB$y26), mean(pTotalIDUB$y27), mean(pTotalIDUB$y28), mean(pTotalIDUB$y29), mean(pTotalIDUB$y30)))
TotalIDU$floor <- c(min(pTotalIDUB$y6), min(pTotalIDUB$y7), min(pTotalIDUB$y8), min(pTotalIDUB$y9), min(pTotalIDUB$y10), min(pTotalIDUB$y11), min(pTotalIDUB$y12), min(pTotalIDUB$y13), min(pTotalIDUB$y14), min(pTotalIDUB$y15), min(pTotalIDUB$y16), min(pTotalIDUB$y17), min(pTotalIDUB$y18), min(pTotalIDUB$y19), min(pTotalIDUB$y20), min(pTotalIDUB$y21), min(pTotalIDUB$y22), min(pTotalIDUB$y23), min(pTotalIDUB$y24), min(pTotalIDUB$y25), min(pTotalIDUB$y26), min(pTotalIDUB$y27), min(pTotalIDUB$y28), min(pTotalIDUB$y29), min(pTotalIDUB$y30))
TotalIDU$ceiling <- c(max(pTotalIDUB$y6), max(pTotalIDUB$y7), max(pTotalIDUB$y8), max(pTotalIDUB$y9), max(pTotalIDUB$y10), max(pTotalIDUB$y11), max(pTotalIDUB$y12), max(pTotalIDUB$y13), max(pTotalIDUB$y14), max(pTotalIDUB$y15), max(pTotalIDUB$y16), max(pTotalIDUB$y17), max(pTotalIDUB$y18), max(pTotalIDUB$y19), max(pTotalIDUB$y20), max(pTotalIDUB$y21), max(pTotalIDUB$y22), max(pTotalIDUB$y23), max(pTotalIDUB$y24), max(pTotalIDUB$y25), max(pTotalIDUB$y26), max(pTotalIDUB$y27), max(pTotalIDUB$y28), max(pTotalIDUB$y29), max(pTotalIDUB$y30))
TotalIDU$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
TotalIDU$Description <- c("total IDU")

TotalIDUProp <- data.frame("Population"=c(((mean(pTotalIDUB$y6)/mean(pTotalB$y6))*100) , ((mean(pTotalIDUB$y7)/mean(pTotalB$y7))*100) , ((mean(pTotalIDUB$y8)/mean(pTotalB$y8))*100) , ((mean(pTotalIDUB$y9)/mean(pTotalB$y9))*100) , ((mean(pTotalIDUB$y10)/mean(pTotalB$y10))*100) , ((mean(pTotalIDUB$y11)/mean(pTotalB$y11))*100) , ((mean(pTotalIDUB$y12)/mean(pTotalB$y12))*100) , ((mean(pTotalIDUB$y13)/mean(pTotalB$y13))*100) , ((mean(pTotalIDUB$y14)/mean(pTotalB$y14))*100) , ((mean(pTotalIDUB$y15)/mean(pTotalB$y15))*100) , ((mean(pTotalIDUB$y16)/mean(pTotalB$y16))*100), ((mean(pTotalIDUB$y17)/mean(pTotalB$y17))*100), ((mean(pTotalIDUB$y18)/mean(pTotalB$y18))*100), ((mean(pTotalIDUB$y19)/mean(pTotalB$y19))*100), ((mean(pTotalIDUB$y20)/mean(pTotalB$y20))*100), ((mean(pTotalIDUB$y21)/mean(pTotalB$y21))*100), ((mean(pTotalIDUB$y22)/mean(pTotalB$y22))*100), ((mean(pTotalIDUB$y23)/mean(pTotalB$y23))*100), ((mean(pTotalIDUB$y24)/mean(pTotalB$y24))*100), ((mean(pTotalIDUB$y25)/mean(pTotalB$y25))*100), ((mean(pTotalIDUB$y26)/mean(pTotalB$y26))*100), ((mean(pTotalIDUB$y27)/mean(pTotalB$y27))*100), ((mean(pTotalIDUB$y28)/mean(pTotalB$y28))*100), ((mean(pTotalIDUB$y29)/mean(pTotalB$y29))*100), ((mean(pTotalIDUB$y30)/mean(pTotalB$y30))*100) ))
TotalIDUProp$floor <- c(((min(pTotalIDUB$y6)/mean(pTotalB$y6))*100) , ((min(pTotalIDUB$y7)/mean(pTotalB$y7))*100) , ((min(pTotalIDUB$y8)/mean(pTotalB$y8))*100) , ((min(pTotalIDUB$y9)/mean(pTotalB$y9))*100) , ((min(pTotalIDUB$y10)/mean(pTotalB$y10))*100) , ((min(pTotalIDUB$y11)/mean(pTotalB$y11))*100) , ((min(pTotalIDUB$y12)/mean(pTotalB$y12))*100) , ((min(pTotalIDUB$y13)/mean(pTotalB$y13))*100) , ((min(pTotalIDUB$y14)/mean(pTotalB$y14))*100) , ((min(pTotalIDUB$y15)/mean(pTotalB$y15))*100) , ((min(pTotalIDUB$y16)/mean(pTotalB$y16))*100) , ((min(pTotalIDUB$y17)/mean(pTotalB$y17))*100) , ((min(pTotalIDUB$y18)/mean(pTotalB$y18))*100) , ((min(pTotalIDUB$y19)/mean(pTotalB$y19))*100) , ((min(pTotalIDUB$y20)/mean(pTotalB$y20))*100) , ((min(pTotalIDUB$y21)/mean(pTotalB$y21))*100) , ((min(pTotalIDUB$y22)/mean(pTotalB$y22))*100) , ((min(pTotalIDUB$y23)/mean(pTotalB$y23))*100) , ((min(pTotalIDUB$y24)/mean(pTotalB$y24))*100) , ((min(pTotalIDUB$y25)/mean(pTotalB$y25))*100) , ((min(pTotalIDUB$y26)/mean(pTotalB$y26))*100) , ((min(pTotalIDUB$y27)/mean(pTotalB$y27))*100) , ((min(pTotalIDUB$y28)/mean(pTotalB$y28))*100) , ((min(pTotalIDUB$y29)/mean(pTotalB$y29))*100) , ((min(pTotalIDUB$y30)/mean(pTotalB$y30))*100) )
TotalIDUProp$ceiling <- c(((max(pTotalIDUB$y6)/mean(pTotalB$y6))*100) , ((max(pTotalIDUB$y7)/mean(pTotalB$y7))*100) , ((max(pTotalIDUB$y8)/mean(pTotalB$y8))*100) , ((max(pTotalIDUB$y9)/mean(pTotalB$y9))*100) , ((max(pTotalIDUB$y10)/mean(pTotalB$y10))*100) , ((max(pTotalIDUB$y11)/mean(pTotalB$y11))*100) , ((max(pTotalIDUB$y12)/mean(pTotalB$y12))*100) , ((max(pTotalIDUB$y13)/mean(pTotalB$y13))*100) , ((max(pTotalIDUB$y14)/mean(pTotalB$y14))*100) , ((max(pTotalIDUB$y15)/mean(pTotalB$y15))*100) , ((max(pTotalIDUB$y16)/mean(pTotalB$y16))*100) , ((max(pTotalIDUB$y17)/mean(pTotalB$y17))*100) , ((max(pTotalIDUB$y18)/mean(pTotalB$y18))*100) , ((max(pTotalIDUB$y19)/mean(pTotalB$y19))*100) , ((max(pTotalIDUB$y20)/mean(pTotalB$y20))*100) , ((max(pTotalIDUB$y21)/mean(pTotalB$y21))*100) , ((max(pTotalIDUB$y22)/mean(pTotalB$y22))*100) , ((max(pTotalIDUB$y23)/mean(pTotalB$y23))*100) , ((max(pTotalIDUB$y24)/mean(pTotalB$y24))*100) , ((max(pTotalIDUB$y25)/mean(pTotalB$y25))*100) , ((max(pTotalIDUB$y26)/mean(pTotalB$y26))*100) , ((max(pTotalIDUB$y27)/mean(pTotalB$y27))*100) , ((max(pTotalIDUB$y28)/mean(pTotalB$y28))*100) , ((max(pTotalIDUB$y29)/mean(pTotalB$y29))*100) , ((max(pTotalIDUB$y30)/mean(pTotalB$y30))*100) )
TotalIDUProp$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
TotalIDUProp$Description <- c("total IDU prop")

Opd <- data.frame("Population"=c(mean(pOpdB$y6), mean(pOpdB$y7), mean(pOpdB$y8), mean(pOpdB$y9), mean(pOpdB$y10), mean(pOpdB$y11), mean(pOpdB$y12), mean(pOpdB$y13), mean(pOpdB$y14), mean(pOpdB$y15), mean(pOpdB$y16), mean(pOpdB$y17), mean(pOpdB$y18), mean(pOpdB$y19), mean(pOpdB$y20), mean(pOpdB$y21), mean(pOpdB$y22), mean(pOpdB$y23), mean(pOpdB$y24), mean(pOpdB$y25), mean(pOpdB$y26), mean(pOpdB$y27), mean(pOpdB$y28), mean(pOpdB$y29), mean(pOpdB$y30)))
Opd$floor <- c(min(pOpdB$y6), min(pOpdB$y7), min(pOpdB$y8), min(pOpdB$y9), min(pOpdB$y10), min(pOpdB$y11), min(pOpdB$y12), min(pOpdB$y13), min(pOpdB$y14), min(pOpdB$y15), min(pOpdB$y16), min(pOpdB$y17), min(pOpdB$y18), min(pOpdB$y19), min(pOpdB$y20), min(pOpdB$y21), min(pOpdB$y22), min(pOpdB$y23), min(pOpdB$y24), min(pOpdB$y25), min(pOpdB$y26), min(pOpdB$y27), min(pOpdB$y28), min(pOpdB$y29), min(pOpdB$y30))
Opd$ceiling <- c(max(pOpdB$y6), max(pOpdB$y7), max(pOpdB$y8), max(pOpdB$y9), max(pOpdB$y10), max(pOpdB$y11), max(pOpdB$y12), max(pOpdB$y13), max(pOpdB$y14), max(pOpdB$y15), max(pOpdB$y16), max(pOpdB$y17), max(pOpdB$y18), max(pOpdB$y19), max(pOpdB$y20), max(pOpdB$y21), max(pOpdB$y22), max(pOpdB$y23), max(pOpdB$y24), max(pOpdB$y25), max(pOpdB$y26), max(pOpdB$y27), max(pOpdB$y28), max(pOpdB$y29), max(pOpdB$y30))
Opd$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
Opd$Description <- c("opioid injecting")

OpdProp <- data.frame("Population"=c(((mean(pOpdB$y6)/mean(pTotalB$y6))*100) , ((mean(pOpdB$y7)/mean(pTotalB$y7))*100) , ((mean(pOpdB$y8)/mean(pTotalB$y8))*100) , ((mean(pOpdB$y9)/mean(pTotalB$y9))*100) , ((mean(pOpdB$y10)/mean(pTotalB$y10))*100) , ((mean(pOpdB$y11)/mean(pTotalB$y11))*100) , ((mean(pOpdB$y12)/mean(pTotalB$y12))*100) , ((mean(pOpdB$y13)/mean(pTotalB$y13))*100) , ((mean(pOpdB$y14)/mean(pTotalB$y14))*100) , ((mean(pOpdB$y15)/mean(pTotalB$y15))*100) , ((mean(pOpdB$y16)/mean(pTotalB$y16))*100) , ((mean(pOpdB$y17)/mean(pTotalB$y17))*100) , ((mean(pOpdB$y18)/mean(pTotalB$y18))*100) , ((mean(pOpdB$y19)/mean(pTotalB$y19))*100) , ((mean(pOpdB$y20)/mean(pTotalB$y20))*100) , ((mean(pOpdB$y21)/mean(pTotalB$y21))*100) , ((mean(pOpdB$y22)/mean(pTotalB$y22))*100) , ((mean(pOpdB$y23)/mean(pTotalB$y23))*100) , ((mean(pOpdB$y24)/mean(pTotalB$y24))*100) , ((mean(pOpdB$y25)/mean(pTotalB$y25))*100) , ((mean(pOpdB$y26)/mean(pTotalB$y26))*100) , ((mean(pOpdB$y27)/mean(pTotalB$y27))*100) , ((mean(pOpdB$y28)/mean(pTotalB$y28))*100) , ((mean(pOpdB$y29)/mean(pTotalB$y29))*100) , ((mean(pOpdB$y30)/mean(pTotalB$y30))*100)  ))
OpdProp$floor <- c(((min(pOpdB$y6)/mean(pTotalB$y6))*100) , ((min(pOpdB$y7)/mean(pTotalB$y7))*100) , ((min(pOpdB$y8)/mean(pTotalB$y8))*100) , ((min(pOpdB$y9)/mean(pTotalB$y9))*100) , ((min(pOpdB$y10)/mean(pTotalB$y10))*100) , ((min(pOpdB$y11)/mean(pTotalB$y11))*100) , ((min(pOpdB$y12)/mean(pTotalB$y12))*100) , ((min(pOpdB$y13)/mean(pTotalB$y13))*100) , ((min(pOpdB$y14)/mean(pTotalB$y14))*100) , ((min(pOpdB$y15)/mean(pTotalB$y15))*100) , ((min(pOpdB$y16)/mean(pTotalB$y16))*100) , ((min(pOpdB$y17)/mean(pTotalB$y17))*100) , ((min(pOpdB$y18)/mean(pTotalB$y18))*100) , ((min(pOpdB$y19)/mean(pTotalB$y19))*100) , ((min(pOpdB$y20)/mean(pTotalB$y20))*100) , ((min(pOpdB$y21)/mean(pTotalB$y21))*100) , ((min(pOpdB$y22)/mean(pTotalB$y22))*100) , ((min(pOpdB$y23)/mean(pTotalB$y23))*100) , ((min(pOpdB$y24)/mean(pTotalB$y24))*100) , ((min(pOpdB$y25)/mean(pTotalB$y25))*100) , ((min(pOpdB$y26)/mean(pTotalB$y26))*100) , ((min(pOpdB$y27)/mean(pTotalB$y27))*100) , ((min(pOpdB$y28)/mean(pTotalB$y28))*100) , ((min(pOpdB$y29)/mean(pTotalB$y29))*100) , ((min(pOpdB$y30)/mean(pTotalB$y30))*100)  )
OpdProp$ceiling <- c(((max(pOpdB$y6)/mean(pTotalB$y6))*100) , ((max(pOpdB$y7)/mean(pTotalB$y7))*100) , ((max(pOpdB$y8)/mean(pTotalB$y8))*100) , ((max(pOpdB$y9)/mean(pTotalB$y9))*100) , ((max(pOpdB$y10)/mean(pTotalB$y10))*100) , ((max(pOpdB$y11)/mean(pTotalB$y11))*100) , ((max(pOpdB$y12)/mean(pTotalB$y12))*100) , ((max(pOpdB$y13)/mean(pTotalB$y13))*100) , ((max(pOpdB$y14)/mean(pTotalB$y14))*100) , ((max(pOpdB$y15)/mean(pTotalB$y15))*100) , ((max(pOpdB$y16)/mean(pTotalB$y16))*100) , ((max(pOpdB$y17)/mean(pTotalB$y17))*100) , ((max(pOpdB$y18)/mean(pTotalB$y18))*100) , ((max(pOpdB$y19)/mean(pTotalB$y19))*100) , ((max(pOpdB$y20)/mean(pTotalB$y20))*100) , ((max(pOpdB$y21)/mean(pTotalB$y21))*100) , ((max(pOpdB$y22)/mean(pTotalB$y22))*100) , ((max(pOpdB$y23)/mean(pTotalB$y23))*100) , ((max(pOpdB$y24)/mean(pTotalB$y24))*100) , ((max(pOpdB$y25)/mean(pTotalB$y25))*100) , ((max(pOpdB$y26)/mean(pTotalB$y26))*100) , ((max(pOpdB$y27)/mean(pTotalB$y27))*100) , ((max(pOpdB$y28)/mean(pTotalB$y28))*100) , ((max(pOpdB$y29)/mean(pTotalB$y29))*100) , ((max(pOpdB$y30)/mean(pTotalB$y30))*100)  )
OpdProp$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
...
NOpd$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
...
NOpdProp$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
NOpdProp$Description <- c("non-opioid PWID")

EverIDU <- data.frame("Population"=c(mean(pEverIDUB$y6), mean(pEverIDUB$y7), mean(pEverIDUB$y8), mean(pEverIDUB$y9), mean(pEverIDUB$y10), mean(pEverIDUB$y11), mean(pEverIDUB$y12), mean(pEverIDUB$y13), mean(pEverIDUB$y14), mean(pEverIDUB$y15), mean(pEverIDUB$y16), mean(pEverIDUB$y17), mean(pEverIDUB$y18), mean(pEverIDUB$y19), mean(pEverIDUB$y20), mean(pEverIDUB$y21), mean(pEverIDUB$y22), mean(pEverIDUB$y23), mean(pEverIDUB$y24), mean(pEverIDUB$y25), mean(pEverIDUB$y26), mean(pEverIDUB$y27), mean(pEverIDUB$y28), mean(pEverIDUB$y29), mean(pEverIDUB$y30)))
EverIDU$floor <- c(min(pEverIDUB$y6), min(pEverIDUB$y7), min(pEverIDUB$y8), min(pEverIDUB$y9), min(pEverIDUB$y10), min(pEverIDUB$y11), min(pEverIDUB$y12), min(pEverIDUB$y13), min(pEverIDUB$y14), min(pEverIDUB$y15), min(pEverIDUB$y16), min(pEverIDUB$y17), min(pEverIDUB$y18), min(pEverIDUB$y19), min(pEverIDUB$y20), min(pEverIDUB$y21), min(pEverIDUB$y22), min(pEverIDUB$y23), min(pEverIDUB$y24), min(pEverIDUB$y25), min(pEverIDUB$y26), min(pEverIDUB$y27), min(pEverIDUB$y28), min(pEverIDUB$y29), min(pEverIDUB$y30))
EverIDU$ceiling <- c(max(pEverIDUB$y6), max(pEverIDUB$y7), max(pEverIDUB$y8), max(pEverIDUB$y9), max(pEverIDUB$y10), max(pEverIDUB$y11), max(pEverIDUB$y12), max(pEverIDUB$y13), max(pEverIDUB$y14), max(pEverIDUB$y15), max(pEverIDUB$y16), max(pEverIDUB$y17), max(pEverIDUB$y18), max(pEverIDUB$y19), max(pEverIDUB$y20), max(pEverIDUB$y21), max(pEverIDUB$y22), max(pEverIDUB$y23), max(pEverIDUB$y24), max(pEverIDUB$y25), max(pEverIDUB$y26), max(pEverIDUB$y27), max(pEverIDUB$y28), max(pEverIDUB$y29), max(pEverIDUB$y30))
EverIDU$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
EverIDU$Description <- c("total ever IDU")

EverIDUProp <- data.frame("Population"=c(((mean(pEverIDUB$y6)/mean(pTotalB$y6))*100) , ((mean(pEverIDUB$y7)/mean(pTotalB$y7))*100) , ((mean(pEverIDUB$y8)/mean(pTotalB$y8))*100) , ((mean(pEverIDUB$y9)/mean(pTotalB$y9))*100) , ((mean(pEverIDUB$y10)/mean(pTotalB$y10))*100) , ((mean(pEverIDUB$y11)/mean(pTotalB$y11))*100) , ((mean(pEverIDUB$y12)/mean(pTotalB$y12))*100) , ((mean(pEverIDUB$y13)/mean(pTotalB$y13))*100) , ((mean(pEverIDUB$y14)/mean(pTotalB$y14))*100) , ((mean(pEverIDUB$y15)/mean(pTotalB$y15))*100) , ((mean(pEverIDUB$y16)/mean(pTotalB$y16))*100), ((mean(pEverIDUB$y17)/mean(pTotalB$y17))*100), ((mean(pEverIDUB$y18)/mean(pTotalB$y18))*100), ((mean(pEverIDUB$y19)/mean(pTotalB$y19))*100), ((mean(pEverIDUB$y20)/mean(pTotalB$y20))*100), ((mean(pEverIDUB$y21)/mean(pTotalB$y21))*100), ((mean(pEverIDUB$y22)/mean(pTotalB$y22))*100), ((mean(pEverIDUB$y23)/mean(pTotalB$y23))*100), ((mean(pEverIDUB$y24)/mean(pTotalB$y24))*100), ((mean(pEverIDUB$y25)/mean(pTotalB$y25))*100), ((mean(pEverIDUB$y26)/mean(pTotalB$y26))*100), ((mean(pEverIDUB$y27)/mean(pTotalB$y27))*100), ((mean(pEverIDUB$y28)/mean(pTotalB$y28))*100), ((mean(pEverIDUB$y29)/mean(pTotalB$y29))*100), ((mean(pEverIDUB$y30)/mean(pTotalB$y30))*100) ))
EverIDUProp$floor <- c(((min(pEverIDUB$y6)/mean(pTotalB$y6))*100) , ((min(pEverIDUB$y7)/mean(pTotalB$y7))*100) , ((min(pEverIDUB$y8)/mean(pTotalB$y8))*100) , ((min(pEverIDUB$y9)/mean(pTotalB$y9))*100) , ((min(pEverIDUB$y10)/mean(pTotalB$y10))*100) , ((min(pEverIDUB$y11)/mean(pTotalB$y11))*100) , ((min(pEverIDUB$y12)/mean(pTotalB$y12))*100) , ((min(pEverIDUB$y13)/mean(pTotalB$y13))*100) , ((min(pEverIDUB$y14)/mean(pTotalB$y14))*100) , ((min(pEverIDUB$y15)/mean(pTotalB$y15))*100) , ((min(pEverIDUB$y16)/mean(pTotalB$y16))*100) , ((min(pEverIDUB$y17)/mean(pTotalB$y17))*100) , ((min(pEverIDUB$y18)/mean(pTotalB$y18))*100) , ((min(pEverIDUB$y19)/mean(pTotalB$y19))*100) , ((min(pEverIDUB$y20)/mean(pTotalB$y20))*100) , ((min(pEverIDUB$y21)/mean(pTotalB$y21))*100) , ((min(pEverIDUB$y22)/mean(pTotalB$y22))*100) , ((min(pEverIDUB$y23)/mean(pTotalB$y23))*100) , ((min(pEverIDUB$y24)/mean(pTotalB$y24))*100) , ((min(pEverIDUB$y25)/mean(pTotalB$y25))*100) , ((min(pEverIDUB$y26)/mean(pTotalB$y26))*100) , ((min(pEverIDUB$y27)/mean(pTotalB$y27))*100) , ((min(pEverIDUB$y28)/mean(pTotalB$y28))*100) , ((min(pEverIDUB$y29)/mean(pTotalB$y29))*100) , ((min(pEverIDUB$y30)/mean(pTotalB$y30))*100) )
EverIDUProp$ceiling <- c(((max(pEverIDUB$y6)/mean(pTotalB$y6))*100) , ((max(pEverIDUB$y7)/mean(pTotalB$y7))*100) , ((max(pEverIDUB$y8)/mean(pTotalB$y8))*100) , ((max(pEverIDUB$y9)/mean(pTotalB$y9))*100) , ((max(pEverIDUB$y10)/mean(pTotalB$y10))*100) , ((max(pEverIDUB$y11)/mean(pTotalB$y11))*100) , ((max(pEverIDUB$y12)/mean(pTotalB$y12))*100) , ((max(pEverIDUB$y13)/mean(pTotalB$y13))*100) , ((max(pEverIDUB$y14)/mean(pTotalB$y14))*100) , ((max(pEverIDUB$y15)/mean(pTotalB$y15))*100) , ((max(pEverIDUB$y16)/mean(pTotalB$y16))*100) , ((max(pEverIDUB$y17)/mean(pTotalB$y17))*100) , ((max(pEverIDUB$y18)/mean(pTotalB$y18))*100) , ((max(pEverIDUB$y19)/mean(pTotalB$y19))*100) , ((max(pEverIDUB$y20)/mean(pTotalB$y20))*100) , ((max(pEverIDUB$y21)/mean(pTotalB$y21))*100) , ((max(pEverIDUB$y22)/mean(pTotalB$y22))*100) , ((max(pEverIDUB$y23)/mean(pTotalB$y23))*100) , ((max(pEverIDUB$y24)/mean(pTotalB$y24))*100) , ((max(pEverIDUB$y25)/mean(pTotalB$y25))*100) , ((max(pEverIDUB$y26)/mean(pTotalB$y26))*100) , ((max(pEverIDUB$y27)/mean(pTotalB$y27))*100) , ((max(pEverIDUB$y28)/mean(pTotalB$y28))*100) , ((max(pEverIDUB$y29)/mean(pTotalB$y29))*100) , ((max(pEverIDUB$y30)/mean(pTotalB$y30))*100) )
EverIDUProp$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
...
Active$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
...
ActiveProp$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
...
NActive$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
...
NActiveProp$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
...
NSWIHSaProp$Year <- c("2015")
NSWIHSaProp$Description <- c("Reported ever IDU") #Stop-c and NSW inmate health survey 2015
...
HITSProp$Description <- c("Reported opioid PWID") #HITS-p

Subpops <- NULL
Subpops <- rbind(NOpdProp, OpdProp, NActiveProp)
Subpops <- subset(Subpops, Subpops$Year<=2018)

PlotC <- ggplot(data=Subpops, aes(x=Year)) + geom_bar(stat="identity", aes(y=Population, fill=Description)) + geom_errorbar(aes(ymin=floor, ymax=ceiling), colour="black", width=.1, position="identity") + scale_fill_manual(values=c("#DCDBDB", "#BBB9B9", "#6F6E6E", "#FFFFFF", "#FFFFFF")) + geom_point(data=HITSProp, mapping=aes(x=Year, y=Population, shape=Description), size=3.5) + geom_point(data=NSWIHSaProp, mapping=aes(x=Year, y=Population, shape=Description), size=3.5) + xlab("Year") + ylim(0, 100) + ylab("Proportion of\n incarcerated individuals") + theme_bw() + ggtitle("A") + theme_bw() + theme(legend.position="right", text=element_text(size=19), legend.title=element_blank(), plot.title = element_text(hjust = -0.05, vjust=1), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.text.x = element_text(angle = 40, hjust = 1))
#ggplot(data=Subpops, aes(x=Year, y=Population, fill=Description)) + geom_bar(stat="identity") + geom_errorbar(aes(ymin=floor, ymax=ceiling), colour="black", width=.1, position="identity") + scale_fill_manual(values=c("#DCDBDB", "#BBB9B9", "#6F6E6E", "#FFFFFF", "#FFFFFF")) + geom_point(data=HITSProp, mapping=aes(x=Year, y=Population, shape=Description), size=3.5) + geom_point(data=NSWIHSaProp, mapping=aes(x=Year, y=Population, shape=Description), size=3.5) + xlab("Year") + ylim(0, 100) + ylab("Proportion") + theme_bw() + ggtitle("Subpopulations of incarcerated PWID") + theme_bw() + theme(legend.position="right", text=element_text(size=15), legend.title=element_blank(), plot.title = element_blank(), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
#plotA + geom_point(data=HITSProp, mapping=aes(x=Year, y=Population), size=3.5) + geom_point(data=NSWIHSaProp, mapping=aes(x=Year, y=Population), size=3.5)
#+ geom_line(data=HITSProp, aes(x=Year, y=Population, group= Description, linetype=Description)) 
#+ geom_point(data=NSWIHSbProp, mapping=aes(x=Year, y=Population, shape=Description), size=3.5)

#OpdIDU <- rbind(Active, Opd)
#OpdIDU <- subset(OpdIDU, OpdIDU$Year<=2018)
#PlotD <- ggplot(data=OpdIDU, aes(x=Year, y=Population, group=Description, col=Description, linetype=Description)) + geom_errorbar(aes(ymin=floor, ymax=ceiling), width=.1) + geom_line(aes(linetype=Description, color=Description)) + geom_point(aes(shape=Description), size=3.5) + scale_linetype_manual(values=c("solid", "dashed")) + scale_shape_manual(values=c(19, 17))  + ylab("PWID opioid") + geom_vline(xintercept=c(5), linetype="dotted") + scale_color_manual(values=c("#000000", "#6F6E6E")) + ylim(0, 10000) + ggtitle("B") + theme_bw() + theme(legend.position="right", text=element_text(size=15), legend.title=element_blank(), plot.title = element_text(hjust = -0.05, vjust=1), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.text.x = element_text(angle = 40, hjust = 1))

#HCV antibody and HCV chronicity
HCVaProp <- data.frame("Population"=c(((mean(pHCVantibody$y06)/mean(pTotal$y06))*100), ((mean(pHCVantibody$y07)/mean(pTotal$y07))*100), ((mean(pHCVantibody$y08)/mean(pTotal$y08))*100), ((mean(pHCVantibody$y09)/mean(pTotal$y09))*100), ((mean(pHCVantibody$y10)/mean(pTotal$y10))*100), ((mean(pHCVantibody$y11)/mean(pTotal$y11))*100), ((mean(pHCVantibody$y12)/mean(pTotal$y12))*100), ((mean(pHCVantibody$y13)/mean(pTotal$y13))*100), ((mean(pHCVantibody$y14)/mean(pTotal$y14))*100), ((mean(pHCVantibody$y15)/mean(pTotal$y15))*100), ((mean(pHCVantibody$y16)/mean(pTotal$y16))*100), ((mean(pHCVantibody$y16)/mean(pTotal$y17))*100), ((mean(pHCVantibody$y18)/mean(pTotal$y18))*100)))
HCVaProp$floor <- c(((min(pHCVantibody$y06)/mean(pTotal$y06))*100), ((min(pHCVantibody$y07)/mean(pTotal$y07))*100), ((min(pHCVantibody$y08)/mean(pTotal$y08))*100), ((min(pHCVantibody$y09)/mean(pTotal$y09))*100), ((min(pHCVantibody$y10)/mean(pTotal$y10))*100), ((min(pHCVantibody$y11)/mean(pTotal$y11))*100), ((min(pHCVantibody$y12)/mean(pTotal$y12))*100), ((min(pHCVantibody$y13)/mean(pTotal$y13))*100), ((min(pHCVantibody$y14)/mean(pTotal$y14))*100), ((min(pHCVantibody$y15)/mean(pTotal$y15))*100), ((min(pHCVantibody$y16)/mean(pTotal$y16))*100), ((min(pHCVantibody$y17)/mean(pTotal$y17))*100), ((min(pHCVantibody$y18)/mean(pTotal$y18))*100))
HCVaProp$ceiling <- c(((max(pHCVantibody$y06)/mean(pTotal$y06))*100), ((max(pHCVantibody$y07)/mean(pTotal$y07))*100), ((max(pHCVantibody$y08)/mean(pTotal$y08))*100), ((max(pHCVantibody$y09)/mean(pTotal$y09))*100), ((max(pHCVantibody$y10)/mean(pTotal$y10))*100), ((max(pHCVantibody$y11)/mean(pTotal$y11))*100), ((max(pHCVantibody$y12)/mean(pTotal$y12))*100), ((max(pHCVantibody$y13)/mean(pTotal$y13))*100), ((max(pHCVantibody$y14)/mean(pTotal$y14))*100), ((max(pHCVantibody$y15)/mean(pTotal$y15))*100), ((max(pHCVantibody$y16)/mean(pTotal$y16))*100), ((max(pHCVantibody$y17)/mean(pTotal$y17))*100), ((max(pHCVantibody$y18)/mean(pTotal$y18))*100))
HCVaProp$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018")
HCVaProp$Description <- c("HCV Ab+ RNA-")

HCVcProp <- data.frame("Population"=c(((mean(pHCVchronic$y06)/mean(pTotal$y06))*100), ((mean(pHCVchronic$y07)/mean(pTotal$y07))*100), ((mean(pHCVchronic$y08)/mean(pTotal$y08))*100), ((mean(pHCVchronic$y09)/mean(pTotal$y09))*100), ((mean(pHCVchronic$y10)/mean(pTotal$y10))*100), ((mean(pHCVchronic$y11)/mean(pTotal$y11))*100), ((mean(pHCVchronic$y12)/mean(pTotal$y12))*100), ((mean(pHCVchronic$y13)/mean(pTotal$y13))*100), ((mean(pHCVchronic$y14)/mean(pTotal$y14))*100), ((mean(pHCVchronic$y15)/mean(pTotal$y15))*100), ((mean(pHCVchronic$y16)/mean(pTotal$y16))*100), ((mean(pHCVchronic$y17)/mean(pTotal$y17))*100), ((mean(pHCVchronic$y18)/mean(pTotal$y18))*100)))
HCVcProp$floor <- c(((min(pHCVchronic$y06)/mean(pTotal$y06))*100), ((min(pHCVchronic$y07)/mean(pTotal$y07))*100), ((min(pHCVchronic$y08)/mean(pTotal$y08))*100), ((min(pHCVchronic$y09)/mean(pTotal$y09))*100), ((min(pHCVchronic$y10)/mean(pTotal$y10))*100), ((min(pHCVchronic$y11)/mean(pTotal$y11))*100), ((min(pHCVchronic$y12)/mean(pTotal$y12))*100), ((min(pHCVchronic$y13)/mean(pTotal$y13))*100), ((min(pHCVchronic$y14)/mean(pTotal$y14))*100), ((min(pHCVchronic$y15)/mean(pTotal$y15))*100), ((min(pHCVchronic$y16)/mean(pTotal$y16))*100), ((min(pHCVchronic$y17)/mean(pTotal$y17))*100), ((min(pHCVchronic$y18)/mean(pTotal$y18))*100))
HCVcProp$ceiling <- c(((max(pHCVchronic$y06)/mean(pTotal$y06))*100), ((max(pHCVchronic$y07)/mean(pTotal$y07))*100), ((max(pHCVchronic$y08)/mean(pTotal$y08))*100), ((max(pHCVchronic$y09)/mean(pTotal$y09))*100), ((max(pHCVchronic$y10)/mean(pTotal$y10))*100), ((max(pHCVchronic$y11)/mean(pTotal$y11))*100), ((max(pHCVchronic$y12)/mean(pTotal$y12))*100), ((max(pHCVchronic$y13)/mean(pTotal$y13))*100), ((max(pHCVchronic$y14)/mean(pTotal$y14))*100), ((max(pHCVchronic$y15)/mean(pTotal$y15))*100), ((max(pHCVchronic$y16)/mean(pTotal$y16))*100), ((max(pHCVchronic$y17)/mean(pTotal$y17))*100), ((max(pHCVchronic$y18)/mean(pTotal$y18))*100))
...
#On OST
HCVA <- data.frame("IncidenceIDU"=c(mean(pTotalOSTSumA$y6), mean(pTotalOSTSumA$y7), mean(pTotalOSTSumA$y8), mean(pTotalOSTSumA$y9), mean(pTotalOSTSumA$y10), mean(pTotalOSTSumA$y11), mean(pTotalOSTSumA$y12), mean(pTotalOSTSumA$y13), mean(pTotalOSTSumA$y14), mean(pTotalOSTSumA$y15), mean(pTotalOSTSumA$y16), mean(pTotalOSTSumA$y17), mean(pTotalOSTSumA$y18), mean(pTotalOSTSumA$y19), mean(pTotalOSTSumA$y20), mean(pTotalOSTSumA$y21), mean(pTotalOSTSumA$y22), mean(pTotalOSTSumA$y23), mean(pTotalOSTSumA$y24), mean(pTotalOSTSumA$y25), mean(pTotalOSTSumA$y26), mean(pTotalOSTSumA$y27), mean(pTotalOSTSumA$y28), mean(pTotalOSTSumA$y29), mean(pTotalOSTSumA$y30)))
HCVA$IncidenceFloor <- c(min(pTotalOSTSumA$y6), min(pTotalOSTSumA$y7), min(pTotalOSTSumA$y8), min(pTotalOSTSumA$y9), min(pTotalOSTSumA$y10), min(pTotalOSTSumA$y11), min(pTotalOSTSumA$y12), min(pTotalOSTSumA$y13), min(pTotalOSTSumA$y14), min(pTotalOSTSumA$y15), min(pTotalOSTSumA$y16), min(pTotalOSTSumA$y17), min(pTotalOSTSumA$y18), min(pTotalOSTSumA$y19), min(pTotalOSTSumA$y20), min(pTotalOSTSumA$y21), min(pTotalOSTSumA$y22), min(pTotalOSTSumA$y23), min(pTotalOSTSumA$y24), min(pTotalOSTSumA$y25), min(pTotalOSTSumA$y26), min(pTotalOSTSumA$y27), min(pTotalOSTSumA$y28), min(pTotalOSTSumA$y29), min(pTotalOSTSumA$y30))
HCVA$IncidenceCeiling <- c(max(pTotalOSTSumA$y6), max(pTotalOSTSumA$y7), max(pTotalOSTSumA$y8), max(pTotalOSTSumA$y9), max(pTotalOSTSumA$y10), max(pTotalOSTSumA$y11), max(pTotalOSTSumA$y12), max(pTotalOSTSumA$y13), max(pTotalOSTSumA$y14), max(pTotalOSTSumA$y15), max(pTotalOSTSumA$y16), max(pTotalOSTSumA$y17), max(pTotalOSTSumA$y18), max(pTotalOSTSumA$y19), max(pTotalOSTSumA$y20), max(pTotalOSTSumA$y21), max(pTotalOSTSumA$y22), max(pTotalOSTSumA$y23), max(pTotalOSTSumA$y24), max(pTotalOSTSumA$y25), max(pTotalOSTSumA$y26), max(pTotalOSTSumA$y27), max(pTotalOSTSumA$y28), max(pTotalOSTSumA$y29), max(pTotalOSTSumA$y30))
HCVA$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVA$Description <- c("OST intermediate scenario")#c("OST improved and retained at 1400 opioid users per year")

HCVB <- data.frame("IncidenceIDU"=c(mean(pTotalOSTSumB$y6), mean(pTotalOSTSumB$y7), mean(pTotalOSTSumB$y8), mean(pTotalOSTSumB$y9), mean(pTotalOSTSumB$y10), mean(pTotalOSTSumB$y11), mean(pTotalOSTSumB$y12), mean(pTotalOSTSumB$y13), mean(pTotalOSTSumB$y14), mean(pTotalOSTSumB$y15), mean(pTotalOSTSumB$y16), mean(pTotalOSTSumB$y17), mean(pTotalOSTSumB$y18), mean(pTotalOSTSumB$y19), mean(pTotalOSTSumB$y20), mean(pTotalOSTSumB$y21), mean(pTotalOSTSumB$y22), mean(pTotalOSTSumB$y23), mean(pTotalOSTSumB$y24), mean(pTotalOSTSumB$y25), mean(pTotalOSTSumB$y26), mean(pTotalOSTSumB$y27), mean(pTotalOSTSumB$y28), mean(pTotalOSTSumB$y29), mean(pTotalOSTSumB$y30)))
HCVB$IncidenceFloor <- c(min(pTotalOSTSumB$y6), min(pTotalOSTSumB$y7), min(pTotalOSTSumB$y8), min(pTotalOSTSumB$y9), min(pTotalOSTSumB$y10), min(pTotalOSTSumB$y11), min(pTotalOSTSumB$y12), min(pTotalOSTSumB$y13), min(pTotalOSTSumB$y14), min(pTotalOSTSumB$y15), min(pTotalOSTSumB$y16), min(pTotalOSTSumB$y17), min(pTotalOSTSumB$y18), min(pTotalOSTSumB$y19), min(pTotalOSTSumB$y20), min(pTotalOSTSumB$y21), min(pTotalOSTSumB$y22), min(pTotalOSTSumB$y23), min(pTotalOSTSumB$y24), min(pTotalOSTSumB$y25), min(pTotalOSTSumB$y26), min(pTotalOSTSumB$y27), min(pTotalOSTSumB$y28), min(pTotalOSTSumB$y29), min(pTotalOSTSumB$y30))
HCVB$IncidenceCeiling <- c(max(pTotalOSTSumB$y6), max(pTotalOSTSumB$y7), max(pTotalOSTSumB$y8), max(pTotalOSTSumB$y9), max(pTotalOSTSumB$y10), max(pTotalOSTSumB$y11), max(pTotalOSTSumB$y12), max(pTotalOSTSumB$y13), max(pTotalOSTSumB$y14), max(pTotalOSTSumB$y15), max(pTotalOSTSumB$y16), max(pTotalOSTSumB$y17), max(pTotalOSTSumB$y18), max(pTotalOSTSumB$y19), max(pTotalOSTSumB$y20), max(pTotalOSTSumB$y21), max(pTotalOSTSumB$y22), max(pTotalOSTSumB$y23), max(pTotalOSTSumB$y24), max(pTotalOSTSumB$y25), max(pTotalOSTSumB$y26), max(pTotalOSTSumB$y27), max(pTotalOSTSumB$y28), max(pTotalOSTSumB$y29), max(pTotalOSTSumB$y30))
...
HCVB$Description <- c("OST optimistic scenario")#c("OST improved and given to all PWID")

HCVC <- data.frame("IncidenceIDU"=c(mean(pTotalOSTSumC$y6), mean(pTotalOSTSumC$y7), mean(pTotalOSTSumC$y8), mean(pTotalOSTSumC$y9), mean(pTotalOSTSumC$y10), mean(pTotalOSTSumC$y11), mean(pTotalOSTSumC$y12), mean(pTotalOSTSumC$y13), mean(pTotalOSTSumC$y14), mean(pTotalOSTSumC$y15), mean(pTotalOSTSumC$y16), mean(pTotalOSTSumC$y17), mean(pTotalOSTSumC$y18), mean(pTotalOSTSumC$y19), mean(pTotalOSTSumC$y20), mean(pTotalOSTSumC$y21), mean(pTotalOSTSumC$y22), mean(pTotalOSTSumC$y23), mean(pTotalOSTSumC$y24), mean(pTotalOSTSumC$y25), mean(pTotalOSTSumC$y26), mean(pTotalOSTSumC$y27), mean(pTotalOSTSumC$y28), mean(pTotalOSTSumC$y29), mean(pTotalOSTSumC$y30)))
HCVC$IncidenceFloor <- c(min(pTotalOSTSumC$y6), min(pTotalOSTSumC$y7), min(pTotalOSTSumC$y8), min(pTotalOSTSumC$y9), min(pTotalOSTSumC$y10), min(pTotalOSTSumC$y11), min(pTotalOSTSumC$y12), min(pTotalOSTSumC$y13), min(pTotalOSTSumC$y14), min(pTotalOSTSumC$y15), min(pTotalOSTSumC$y16), min(pTotalOSTSumC$y17), min(pTotalOSTSumC$y18), min(pTotalOSTSumC$y19), min(pTotalOSTSumC$y20), min(pTotalOSTSumC$y21), min(pTotalOSTSumC$y22), min(pTotalOSTSumC$y23), min(pTotalOSTSumC$y24), min(pTotalOSTSumC$y25), min(pTotalOSTSumC$y26), min(pTotalOSTSumC$y27), min(pTotalOSTSumC$y28), min(pTotalOSTSumC$y29), min(pTotalOSTSumC$y30))
HCVC$IncidenceCeiling <- c(max(pTotalOSTSumC$y6), max(pTotalOSTSumC$y7), max(pTotalOSTSumC$y8), max(pTotalOSTSumC$y9), max(pTotalOSTSumC$y10), max(pTotalOSTSumC$y11), max(pTotalOSTSumC$y12), max(pTotalOSTSumC$y13), max(pTotalOSTSumC$y14), max(pTotalOSTSumC$y15), max(pTotalOSTSumC$y16), max(pTotalOSTSumC$y17), max(pTotalOSTSumC$y18), max(pTotalOSTSumC$y19), max(pTotalOSTSumC$y20), max(pTotalOSTSumC$y21), max(pTotalOSTSumC$y22), max(pTotalOSTSumC$y23), max(pTotalOSTSumC$y24), max(pTotalOSTSumC$y25), max(pTotalOSTSumC$y26), max(pTotalOSTSumC$y27), max(pTotalOSTSumC$y28), max(pTotalOSTSumC$y29), max(pTotalOSTSumC$y30))
...
HCVC$Description <- c("OST pessimistic scenario")#c("OST retained at 1400 PWID per year without improvement")

incHCVIDU <- rbind(HCVA, HCVB, HCVC)
#PlotA <- ggplot(data=incHCVIDU, aes(x=Year, y=IncidenceIDU, group=Description, col=Description, linetype=Description)) + geom_errorbar(aes(ymin=IncidenceFloor, ymax=IncidenceCeiling), width=.1) + geom_line(aes(linetype=Description, color=Description)) + geom_point(aes(shape=Description), size=3.5) + scale_linetype_manual(values=c("solid","twodash","dotted", "longdash", "dotdash")) + scale_shape_manual(values=c(19, 15, 8, 17, 4))  + ylab("HCV incidence\n among PWID") + geom_vline(xintercept=c(9, 13), linetype="dotted") + scale_color_manual(values=c("#660000", "#006633", "#000000", "#003366", "#000000")) + ylim(0, 30) + geom_point(data=HCVEvan, mapping=aes(x=Year, y=IncidenceIDU, shape=Description), size=3.5) + geom_errorbar(data=HCVEvan, mapping=aes(ymin=IncidenceIDU-IncidenceIDUCI, ymax=IncidenceIDU+IncidenceIDUCI), colour="black", width=.1) + geom_point(data=HCVStopc, mapping=aes(x=Year, y=IncidenceIDU, shape=Description), size=3.5) + ggtitle("A") + theme_bw() + theme(legend.position="right", text=element_text(size=15), legend.title=element_blank(), plot.title = element_text(hjust = -0.05, vjust=1), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.text.x = element_text(angle = 90, hjust = 1))
PlotA <- ggplot(data=incHCVIDU, aes(x=Year, y=IncidenceIDU, group=Description, col=Description, linetype=Description)) + geom_errorbar(aes(ymin=IncidenceFloor, ymax=IncidenceCeiling), width=.1) + geom_line(aes(linetype=Description, color=Description)) + geom_point(aes(shape=Description), size=3.5) + scale_linetype_manual(values=c("dotdash", "solid", "longdash", "twodash", "dotted")) + scale_shape_manual(values=c(15, 19, 17, 4, 8))  + ylab("Number of people on OST") + geom_vline(xintercept=c(5), linetype="dotted") + scale_color_manual(values=c("#006633", "#660000", "#003366", "#000000", "#000000")) + ylim(0, 10000) + ggtitle("A") + theme_bw() + theme(legend.position="right", text=element_text(size=15), legend.title=element_blank(), plot.title = element_text(hjust = -0.05, vjust=1), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.text.x = element_text(angle = 40, hjust = 1))
...
HCVB$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVB$Description <- c("OST optimistic scenario")#c("OST improved and increased to all PWID")
...
HCVC$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVC$Description <- c("OST pessimistic scenario")#c("OST retained at 1400 opioid users per year without improvement")

incHCVIDU <- rbind(HCVA, HCVB, HCVC)
#PlotA <- ggplot(data=incHCVIDU, aes(x=Year, y=IncidenceIDU, group=Description, col=Description, linetype=Description)) + geom_errorbar(aes(ymin=IncidenceFloor, ymax=IncidenceCeiling), width=.1) + geom_line(aes(linetype=Description, color=Description)) + geom_point(aes(shape=Description), size=3.5) + scale_linetype_manual(values=c("solid","twodash","dotted", "longdash", "dotdash")) + scale_shape_manual(values=c(19, 15, 8, 17, 4))  + ylab("HCV incidence\n among PWID") + geom_vline(xintercept=c(9, 13), linetype="dotted") + scale_color_manual(values=c("#660000", "#006633", "#000000", "#003366", "#000000")) + ylim(0, 30) + geom_point(data=HCVEvan, mapping=aes(x=Year, y=IncidenceIDU, shape=Description), size=3.5) + geom_errorbar(data=HCVEvan, mapping=aes(ymin=IncidenceIDU-IncidenceIDUCI, ymax=IncidenceIDU+IncidenceIDUCI), colour="black", width=.1) + geom_point(data=HCVStopc, mapping=aes(x=Year, y=IncidenceIDU, shape=Description), size=3.5) + ggtitle("A") + theme_bw() + theme(legend.position="right", text=element_text(size=15), legend.title=element_blank(), plot.title = element_text(hjust = -0.05, vjust=1), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.text.x = element_text(angle = 90, hjust = 1))
PlotB <- ggplot(data=incHCVIDU, aes(x=Year, y=IncidenceIDU, group=Description, col=Description, linetype=Description)) + geom_errorbar(aes(ymin=IncidenceFloor, ymax=IncidenceCeiling), width=.1) + geom_line(aes(linetype=Description, color=Description)) + geom_point(aes(shape=Description), size=3.5) + scale_linetype_manual(values=c("dotdash", "solid", "longdash", "twodash", "dotted")) + scale_shape_manual(values=c(15, 19, 17, 4, 8))  + ylab("New HCV cases") + geom_vline(xintercept=c(5), linetype="dotted") + scale_color_manual(values=c("#006633", "#660000", "#003366", "#000000", "#000000"))  + ylim(0, 1500) + ggtitle("B") + theme_bw() + theme(legend.position="right", text=element_text(size=15), legend.title=element_blank(), plot.title = element_text(hjust = -0.05, vjust=1), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.text.x = element_text(angle = 40, hjust = 1))
...
HCVOSTA <- data.frame("IncidenceIDU"=c(mean(pNewCasesOSTSumA$y6), mean(pNewCasesOSTSumA$y7), mean(pNewCasesOSTSumA$y8), mean(pNewCasesOSTSumA$y9), mean(pNewCasesOSTSumA$y10), mean(pNewCasesOSTSumA$y11), mean(pNewCasesOSTSumA$y12), mean(pNewCasesOSTSumA$y13), mean(pNewCasesOSTSumA$y14), mean(pNewCasesOSTSumA$y15), mean(pNewCasesOSTSumA$y16), mean(pNewCasesOSTSumA$y17), mean(pNewCasesOSTSumA$y18), mean(pNewCasesOSTSumA$y19), mean(pNewCasesOSTSumA$y20), mean(pNewCasesOSTSumA$y21), mean(pNewCasesOSTSumA$y22), mean(pNewCasesOSTSumA$y23), mean(pNewCasesOSTSumA$y24), mean(pNewCasesOSTSumA$y25), mean(pNewCasesOSTSumA$y26), mean(pNewCasesOSTSumA$y27), mean(pNewCasesOSTSumA$y28), mean(pNewCasesOSTSumA$y29), mean(pNewCasesOSTSumA$y30)))
HCVOSTA$IncidenceFloor <- c(min(pNewCasesOSTSumA$y6), min(pNewCasesOSTSumA$y7), min(pNewCasesOSTSumA$y8), min(pNewCasesOSTSumA$y9), min(pNewCasesOSTSumA$y10), min(pNewCasesOSTSumA$y11), min(pNewCasesOSTSumA$y12), min(pNewCasesOSTSumA$y13), min(pNewCasesOSTSumA$y14), min(pNewCasesOSTSumA$y15), min(pNewCasesOSTSumA$y16), min(pNewCasesOSTSumA$y17), min(pNewCasesOSTSumA$y18), min(pNewCasesOSTSumA$y19), min(pNewCasesOSTSumA$y20), min(pNewCasesOSTSumA$y21), min(pNewCasesOSTSumA$y22), min(pNewCasesOSTSumA$y23), min(pNewCasesOSTSumA$y24), min(pNewCasesOSTSumA$y25), min(pNewCasesOSTSumA$y26), min(pNewCasesOSTSumA$y27), min(pNewCasesOSTSumA$y28), min(pNewCasesOSTSumA$y29), min(pNewCasesOSTSumA$y30))
HCVOSTA$IncidenceCeiling <- c(max(pNewCasesOSTSumA$y6), max(pNewCasesOSTSumA$y7), max(pNewCasesOSTSumA$y8), max(pNewCasesOSTSumA$y9), max(pNewCasesOSTSumA$y10), max(pNewCasesOSTSumA$y11), max(pNewCasesOSTSumA$y12), max(pNewCasesOSTSumA$y13), max(pNewCasesOSTSumA$y14), max(pNewCasesOSTSumA$y15), max(pNewCasesOSTSumA$y16), max(pNewCasesOSTSumA$y17), max(pNewCasesOSTSumA$y18), max(pNewCasesOSTSumA$y19), max(pNewCasesOSTSumA$y20), max(pNewCasesOSTSumA$y21), max(pNewCasesOSTSumA$y22), max(pNewCasesOSTSumA$y23), max(pNewCasesOSTSumA$y24), max(pNewCasesOSTSumA$y25), max(pNewCasesOSTSumA$y26), max(pNewCasesOSTSumA$y27), max(pNewCasesOSTSumA$y28), max(pNewCasesOSTSumA$y29), max(pNewCasesOSTSumA$y30))
HCVOSTA$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVOSTA$Description <- c("OST intermediate scenario")#c("OST improved and retained at 1400 opioid users per year")#c("OST improved and retained at 1400 opioid users per year")

HCVOSTB <- data.frame("IncidenceIDU"=c(mean(pNewCasesOSTSumB$y6), mean(pNewCasesOSTSumB$y7), mean(pNewCasesOSTSumB$y8), mean(pNewCasesOSTSumB$y9), mean(pNewCasesOSTSumB$y10), mean(pNewCasesOSTSumB$y11), mean(pNewCasesOSTSumB$y12), mean(pNewCasesOSTSumB$y13), mean(pNewCasesOSTSumB$y14), mean(pNewCasesOSTSumB$y15), mean(pNewCasesOSTSumB$y16), mean(pNewCasesOSTSumB$y17), mean(pNewCasesOSTSumB$y18), mean(pNewCasesOSTSumB$y19), mean(pNewCasesOSTSumB$y20), mean(pNewCasesOSTSumB$y21), mean(pNewCasesOSTSumB$y22), mean(pNewCasesOSTSumB$y23), mean(pNewCasesOSTSumB$y24), mean(pNewCasesOSTSumB$y25), mean(pNewCasesOSTSumB$y26), mean(pNewCasesOSTSumB$y27), mean(pNewCasesOSTSumB$y28), mean(pNewCasesOSTSumB$y29), mean(pNewCasesOSTSumB$y30)))
HCVOSTB$IncidenceFloor <- c(min(pNewCasesOSTSumB$y6), min(pNewCasesOSTSumB$y7), min(pNewCasesOSTSumB$y8), min(pNewCasesOSTSumB$y9), min(pNewCasesOSTSumB$y10), min(pNewCasesOSTSumB$y11), min(pNewCasesOSTSumB$y12), min(pNewCasesOSTSumB$y13), min(pNewCasesOSTSumB$y14), min(pNewCasesOSTSumB$y15), min(pNewCasesOSTSumB$y16), min(pNewCasesOSTSumB$y17), min(pNewCasesOSTSumB$y18), min(pNewCasesOSTSumB$y19), min(pNewCasesOSTSumB$y20), min(pNewCasesOSTSumB$y21), min(pNewCasesOSTSumB$y22), min(pNewCasesOSTSumB$y23), min(pNewCasesOSTSumB$y24), min(pNewCasesOSTSumB$y25), min(pNewCasesOSTSumB$y26), min(pNewCasesOSTSumB$y27), min(pNewCasesOSTSumB$y28), min(pNewCasesOSTSumB$y29), min(pNewCasesOSTSumB$y30))
HCVOSTB$IncidenceCeiling <- c(max(pNewCasesOSTSumB$y6), max(pNewCasesOSTSumB$y7), max(pNewCasesOSTSumB$y8), max(pNewCasesOSTSumB$y9), max(pNewCasesOSTSumB$y10), max(pNewCasesOSTSumB$y11), max(pNewCasesOSTSumB$y12), max(pNewCasesOSTSumB$y13), max(pNewCasesOSTSumB$y14), max(pNewCasesOSTSumB$y15), max(pNewCasesOSTSumB$y16), max(pNewCasesOSTSumB$y17), max(pNewCasesOSTSumB$y18), max(pNewCasesOSTSumB$y19), max(pNewCasesOSTSumB$y20), max(pNewCasesOSTSumB$y21), max(pNewCasesOSTSumB$y22), max(pNewCasesOSTSumB$y23), max(pNewCasesOSTSumB$y24), max(pNewCasesOSTSumB$y25), max(pNewCasesOSTSumB$y26), max(pNewCasesOSTSumB$y27), max(pNewCasesOSTSumB$y28), max(pNewCasesOSTSumB$y29), max(pNewCasesOSTSumB$y30))
HCVOSTB$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVOSTB$Description <- c("OST optimistic scenario")#c("OST improved and increased to all PWID")

HCVOSTC <- data.frame("IncidenceIDU"=c(mean(pNewCasesOSTSumC$y6), mean(pNewCasesOSTSumC$y7), mean(pNewCasesOSTSumC$y8), mean(pNewCasesOSTSumC$y9), mean(pNewCasesOSTSumC$y10), mean(pNewCasesOSTSumC$y11), mean(pNewCasesOSTSumC$y12), mean(pNewCasesOSTSumC$y13), mean(pNewCasesOSTSumC$y14), mean(pNewCasesOSTSumC$y15), mean(pNewCasesOSTSumC$y16), mean(pNewCasesOSTSumC$y17), mean(pNewCasesOSTSumC$y18), mean(pNewCasesOSTSumC$y19), mean(pNewCasesOSTSumC$y20), mean(pNewCasesOSTSumC$y21), mean(pNewCasesOSTSumC$y22), mean(pNewCasesOSTSumC$y23), mean(pNewCasesOSTSumC$y24), mean(pNewCasesOSTSumC$y25), mean(pNewCasesOSTSumC$y26), mean(pNewCasesOSTSumC$y27), mean(pNewCasesOSTSumC$y28), mean(pNewCasesOSTSumC$y29), mean(pNewCasesOSTSumC$y30)))
HCVOSTC$IncidenceFloor <- c(min(pNewCasesOSTSumC$y6), min(pNewCasesOSTSumC$y7), min(pNewCasesOSTSumC$y8), min(pNewCasesOSTSumC$y9), min(pNewCasesOSTSumC$y10), min(pNewCasesOSTSumC$y11), min(pNewCasesOSTSumC$y12), min(pNewCasesOSTSumC$y13), min(pNewCasesOSTSumC$y14), min(pNewCasesOSTSumC$y15), min(pNewCasesOSTSumC$y16), min(pNewCasesOSTSumC$y17), min(pNewCasesOSTSumC$y18), min(pNewCasesOSTSumC$y19), min(pNewCasesOSTSumC$y20), min(pNewCasesOSTSumC$y21), min(pNewCasesOSTSumC$y22), min(pNewCasesOSTSumC$y23), min(pNewCasesOSTSumC$y24), min(pNewCasesOSTSumC$y25), min(pNewCasesOSTSumC$y26), min(pNewCasesOSTSumC$y27), min(pNewCasesOSTSumC$y28), min(pNewCasesOSTSumC$y29), min(pNewCasesOSTSumC$y30))
HCVOSTC$IncidenceCeiling <- c(max(pNewCasesOSTSumC$y6), max(pNewCasesOSTSumC$y7), max(pNewCasesOSTSumC$y8), max(pNewCasesOSTSumC$y9), max(pNewCasesOSTSumC$y10), max(pNewCasesOSTSumC$y11), max(pNewCasesOSTSumC$y12), max(pNewCasesOSTSumC$y13), max(pNewCasesOSTSumC$y14), max(pNewCasesOSTSumC$y15), max(pNewCasesOSTSumC$y16), max(pNewCasesOSTSumC$y17), max(pNewCasesOSTSumC$y18), max(pNewCasesOSTSumC$y19), max(pNewCasesOSTSumC$y20), max(pNewCasesOSTSumC$y21), max(pNewCasesOSTSumC$y22), max(pNewCasesOSTSumC$y23), max(pNewCasesOSTSumC$y24), max(pNewCasesOSTSumC$y25), max(pNewCasesOSTSumC$y26), max(pNewCasesOSTSumC$y27), max(pNewCasesOSTSumC$y28), max(pNewCasesOSTSumC$y29), max(pNewCasesOSTSumC$y30))
HCVOSTC$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVOSTC$Description <- c("OST pessimistic scenario")#c("OST retained at 1400 opioid users per year without improvement")

incHCVIDU <- rbind(HCVA, HCVOSTA, HCVOSTB, HCVOSTC)
#PlotA <- ggplot(data=incHCVIDU, aes(x=Year, y=IncidenceIDU, group=Description, col=Description, linetype=Description)) + geom_errorbar(aes(ymin=IncidenceFloor, ymax=IncidenceCeiling), width=.1) + geom_line(aes(linetype=Description, color=Description)) + geom_point(aes(shape=Description), size=3.5) + scale_linetype_manual(values=c("solid","twodash","dotted", "longdash", "dotdash")) + scale_shape_manual(values=c(19, 15, 8, 17, 4))  + ylab("HCV incidence\n among PWID") + geom_vline(xintercept=c(9, 13), linetype="dotted") + scale_color_manual(values=c("#660000", "#006633", "#000000", "#003366", "#000000")) + ylim(0, 30) + geom_point(data=HCVEvan, mapping=aes(x=Year, y=IncidenceIDU, shape=Description), size=3.5) + geom_errorbar(data=HCVEvan, mapping=aes(ymin=IncidenceIDU-IncidenceIDUCI, ymax=IncidenceIDU+IncidenceIDUCI), colour="black", width=.1) + geom_point(data=HCVStopc, mapping=aes(x=Year, y=IncidenceIDU, shape=Description), size=3.5) + ggtitle("A") + theme_bw() + theme(legend.position="right", text=element_text(size=15), legend.title=element_blank(), plot.title = element_text(hjust = -0.05, vjust=1), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.text.x = element_text(angle = 90, hjust = 1))
PlotA <- ggplot(data=incHCVIDU, aes(x=Year, y=IncidenceIDU, group=Description, col=Description, linetype=Description)) + geom_errorbar(aes(ymin=IncidenceFloor, ymax=IncidenceCeiling), width=.1) + geom_line(aes(linetype=Description, color=Description)) + geom_point(aes(shape=Description), size=3.5) + scale_linetype_manual(values=c("dotted", "solid", "longdash", "twodash")) + scale_shape_manual(values=c(8, 19, 17, 15))  + ylab("Number of new infections\n") + geom_vline(xintercept=c(5), linetype="dotted") + scale_color_manual(values=c("#000000", "#660000", "#003366", "#006633")) + ylim(0, 5000) + ggtitle("A") + theme_bw() + theme(legend.position="right", text=element_text(size=15), legend.title=element_blank(), plot.title = element_text(hjust = -0.05, vjust=1), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.text.x = element_text(angle = 40, hjust = 1))

#Incidence and Prevalence
#TotalIDU incidence and prevalence
#HCVA <- data.frame("IncidenceIDU"=c(((mean(pNewCasesA$y6)/mean(pTotalIDUA$y6))*100)*365, ((mean(pNewCasesA$y7)/mean(pTotalIDUA$y7))*100)*365, ((mean(pNewCasesA$y8)/mean(pTotalIDUA$y8))*100)*365, ((mean(pNewCasesA$y9)/mean(pTotalIDUA$y9))*100)*365, ((mean(pNewCasesA$y10)/mean(pTotalIDUA$y10))*100)*365, ((mean(pNewCasesA$y11)/mean(pTotalIDUA$y11))*100)*365, ((mean(pNewCasesA$y12)/mean(pTotalIDUA$y12))*100)*365, ((mean(pNewCasesA$y13)/mean(pTotalIDUA$y13))*100)*365, ((mean(pNewCasesA$y14)/mean(pTotalIDUA$y14))*100)*365, ((mean(pNewCasesA$y15)/mean(pTotalIDUA$y15))*100)*365, ((mean(pNewCasesA$y16)/mean(pTotalIDUA$y16))*100)*365, ((mean(pNewCasesA$y17)/mean(pTotalIDUA$y17))*100)*365, ((mean(pNewCasesA$y18)/mean(pTotalIDUA$y18))*100)*365, ((mean(pNewCasesA$y19)/mean(pTotalIDUA$y19))*100)*365, ((mean(pNewCasesA$y20)/mean(pTotalIDUA$y20))*100)*365, ((mean(pNewCasesA$y21)/mean(pTotalIDUA$y21))*100)*365, ((mean(pNewCasesA$y22)/mean(pTotalIDUA$y22))*100)*365, ((mean(pNewCasesA$y23)/mean(pTotalIDUA$y23))*100)*365, ((mean(pNewCasesA$y24)/mean(pTotalIDUA$y24))*100)*365, ((mean(pNewCasesA$y25)/mean(pTotalIDUA$y25))*100)*365, ((mean(pNewCasesA$y26)/mean(pTotalIDUA$y26))*100)*365, ((mean(pNewCasesA$y27)/mean(pTotalIDUA$y27))*100)*365, ((mean(pNewCasesA$y28)/mean(pTotalIDUA$y28))*100)*365, ((mean(pNewCasesA$y29)/mean(pTotalIDUA$y29))*100)*365, ((mean(pNewCasesA$y30)/mean(pTotalIDUA$y30))*100)*365))
#HCVA$IncidenceFloor <- c(((min(pNewCasesA$y6)/mean(pTotalIDUA$y6))*100)*365, ((min(pNewCasesA$y7)/mean(pTotalIDUA$y7))*100)*365, ((min(pNewCasesA$y8)/mean(pTotalIDUA$y8))*100)*365, ((min(pNewCasesA$y9)/mean(pTotalIDUA$y9))*100)*365, ((min(pNewCasesA$y10)/mean(pTotalIDUA$y10))*100)*365, ((min(pNewCasesA$y11)/mean(pTotalIDUA$y11))*100)*365, ((min(pNewCasesA$y12)/mean(pTotalIDUA$y12))*100)*365, ((min(pNewCasesA$y13)/mean(pTotalIDUA$y13))*100)*365, ((min(pNewCasesA$y14)/mean(pTotalIDUA$y14))*100)*365, ((min(pNewCasesA$y15)/mean(pTotalIDUA$y15))*100)*365, ((min(pNewCasesA$y16)/mean(pTotalIDUA$y16))*100)*365, ((min(pNewCasesA$y17)/mean(pTotalIDUA$y17))*100)*365, ((min(pNewCasesA$y18)/mean(pTotalIDUA$y18))*100)*365, ((min(pNewCasesA$y19)/mean(pTotalIDUA$y19))*100)*365, ((min(pNewCasesA$y20)/mean(pTotalIDUA$y20))*100)*365, ((min(pNewCasesA$y21)/mean(pTotalIDUA$y21))*100)*365, ((min(pNewCasesA$y22)/mean(pTotalIDUA$y22))*100)*365, ((min(pNewCasesA$y23)/mean(pTotalIDUA$y23))*100)*365, ((min(pNewCasesA$y24)/mean(pTotalIDUA$y24))*100)*365, ((min(pNewCasesA$y25)/mean(pTotalIDUA$y25))*100)*365, ((min(pNewCasesA$y26)/mean(pTotalIDUA$y26))*100)*365, ((min(pNewCasesA$y27)/mean(pTotalIDUA$y27))*100)*365, ((min(pNewCasesA$y28)/mean(pTotalIDUA$y28))*100)*365, ((min(pNewCasesA$y29)/mean(pTotalIDUA$y29))*100)*365, ((min(pNewCasesA$y30)/mean(pTotalIDUA$y30))*100)*365)
#HCVA$IncidenceCeiling <- c(((max(pNewCasesA$y6)/mean(pTotalIDUA$y6))*100)*365, ((max(pNewCasesA$y7)/mean(pTotalIDUA$y7))*100)*365, ((max(pNewCasesA$y8)/mean(pTotalIDUA$y8))*100)*365, ((max(pNewCasesA$y9)/mean(pTotalIDUA$y9))*100)*365, ((max(pNewCasesA$y10)/mean(pTotalIDUA$y10))*100)*365, ((max(pNewCasesA$y11)/mean(pTotalIDUA$y11))*100)*365, ((max(pNewCasesA$y12)/mean(pTotalIDUA$y12))*100)*365, ((max(pNewCasesA$y13)/mean(pTotalIDUA$y13))*100)*365, ((max(pNewCasesA$y14)/mean(pTotalIDUA$y14))*100)*365, ((max(pNewCasesA$y15)/mean(pTotalIDUA$y15))*100)*365, ((max(pNewCasesA$y16)/mean(pTotalIDUA$y16))*100)*365, ((max(pNewCasesA$y17)/mean(pTotalIDUA$y17))*100)*365, ((max(pNewCasesA$y18)/mean(pTotalIDUA$y18))*100)*365, ((max(pNewCasesA$y19)/mean(pTotalIDUA$y19))*100)*365, ((max(pNewCasesA$y20)/mean(pTotalIDUA$y20))*100)*365, ((max(pNewCasesA$y21)/mean(pTotalIDUA$y21))*100)*365, ((max(pNewCasesA$y22)/mean(pTotalIDUA$y22))*100)*365, ((max(pNewCasesA$y23)/mean(pTotalIDUA$y23))*100)*365, ((max(pNewCasesA$y24)/mean(pTotalIDUA$y24))*100)*365, ((max(pNewCasesA$y25)/mean(pTotalIDUA$y25))*100)*365, ((max(pNewCasesA$y26)/mean(pTotalIDUA$y26))*100)*365, ((max(pNewCasesA$y27)/mean(pTotalIDUA$y27))*100)*365, ((max(pNewCasesA$y28)/mean(pTotalIDUA$y28))*100)*365, ((max(pNewCasesA$y29)/mean(pTotalIDUA$y29))*100)*365, ((max(pNewCasesA$y30)/mean(pTotalIDUA$y30))*100)*365)
#HCVA$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
#HCVA$Description <- c("OST improved but retained at 1400 per year")

#HCVB <- data.frame("IncidenceIDU"=c(((mean(pNewCasesB$y6)/mean(pTotalIDUB$y6))*100)*365, ((mean(pNewCasesB$y7)/mean(pTotalIDUB$y7))*100)*365, ((mean(pNewCasesB$y8)/mean(pTotalIDUB$y8))*100)*365, ((mean(pNewCasesB$y9)/mean(pTotalIDUB$y9))*100)*365, ((mean(pNewCasesB$y10)/mean(pTotalIDUB$y10))*100)*365, ((mean(pNewCasesB$y11)/mean(pTotalIDUB$y11))*100)*365, ((mean(pNewCasesB$y12)/mean(pTotalIDUB$y12))*100)*365, ((mean(pNewCasesB$y13)/mean(pTotalIDUB$y13))*100)*365, ((mean(pNewCasesB$y14)/mean(pTotalIDUB$y14))*100)*365, ((mean(pNewCasesB$y15)/mean(pTotalIDUB$y15))*100)*365, ((mean(pNewCasesB$y16)/mean(pTotalIDUB$y16))*100)*365, ((mean(pNewCasesB$y17)/mean(pTotalIDUB$y17))*100)*365, ((mean(pNewCasesB$y18)/mean(pTotalIDUB$y18))*100)*365, ((mean(pNewCasesB$y19)/mean(pTotalIDUB$y19))*100)*365, ((mean(pNewCasesB$y20)/mean(pTotalIDUB$y20))*100)*365, ((mean(pNewCasesB$y21)/mean(pTotalIDUB$y21))*100)*365, ((mean(pNewCasesB$y22)/mean(pTotalIDUB$y22))*100)*365, ((mean(pNewCasesB$y23)/mean(pTotalIDUB$y23))*100)*365, ((mean(pNewCasesB$y24)/mean(pTotalIDUB$y24))*100)*365, ((mean(pNewCasesB$y25)/mean(pTotalIDUB$y25))*100)*365, ((mean(pNewCasesB$y26)/mean(pTotalIDUB$y26))*100)*365, ((mean(pNewCasesB$y27)/mean(pTotalIDUB$y27))*100)*365, ((mean(pNewCasesB$y28)/mean(pTotalIDUB$y28))*100)*365, ((mean(pNewCasesB$y29)/mean(pTotalIDUB$y29))*100)*365, ((mean(pNewCasesB$y30)/mean(pTotalIDUB$y30))*100)*365))
#HCVB$IncidenceFloor <- c(((min(pNewCasesB$y6)/mean(pTotalIDUB$y6))*100)*365, ((min(pNewCasesB$y7)/mean(pTotalIDUB$y7))*100)*365, ((min(pNewCasesB$y8)/mean(pTotalIDUB$y8))*100)*365, ((min(pNewCasesB$y9)/mean(pTotalIDUB$y9))*100)*365, ((min(pNewCasesB$y10)/mean(pTotalIDUB$y10))*100)*365, ((min(pNewCasesB$y11)/mean(pTotalIDUB$y11))*100)*365, ((min(pNewCasesB$y12)/mean(pTotalIDUB$y12))*100)*365, ((min(pNewCasesB$y13)/mean(pTotalIDUB$y13))*100)*365, ((min(pNewCasesB$y14)/mean(pTotalIDUB$y14))*100)*365, ((min(pNewCasesB$y15)/mean(pTotalIDUB$y15))*100)*365, ((min(pNewCasesB$y16)/mean(pTotalIDUB$y16))*100)*365, ((min(pNewCasesB$y17)/mean(pTotalIDUB$y17))*100)*365, ((min(pNewCasesB$y18)/mean(pTotalIDUB$y18))*100)*365, ((min(pNewCasesB$y19)/mean(pTotalIDUB$y19))*100)*365, ((min(pNewCasesB$y20)/mean(pTotalIDUB$y20))*100)*365, ((min(pNewCasesB$y21)/mean(pTotalIDUB$y21))*100)*365, ((min(pNewCasesB$y22)/mean(pTotalIDUB$y22))*100)*365, ((min(pNewCasesB$y23)/mean(pTotalIDUB$y23))*100)*365, ((min(pNewCasesB$y24)/mean(pTotalIDUB$y24))*100)*365, ((min(pNewCasesB$y25)/mean(pTotalIDUB$y25))*100)*365, ((min(pNewCasesB$y26)/mean(pTotalIDUB$y26))*100)*365, ((min(pNewCasesB$y27)/mean(pTotalIDUB$y27))*100)*365, ((min(pNewCasesB$y28)/mean(pTotalIDUB$y28))*100)*365, ((min(pNewCasesB$y29)/mean(pTotalIDUB$y29))*100)*365, ((min(pNewCasesB$y30)/mean(pTotalIDUB$y30))*100)*365)
#HCVB$IncidenceCeiling <- c(((max(pNewCasesB$y6)/mean(pTotalIDUB$y6))*100)*365, ((max(pNewCasesB$y7)/mean(pTotalIDUB$y7))*100)*365, ((max(pNewCasesB$y8)/mean(pTotalIDUB$y8))*100)*365, ((max(pNewCasesB$y9)/mean(pTotalIDUB$y9))*100)*365, ((max(pNewCasesB$y10)/mean(pTotalIDUB$y10))*100)*365, ((max(pNewCasesB$y11)/mean(pTotalIDUB$y11))*100)*365, ((max(pNewCasesB$y12)/mean(pTotalIDUB$y12))*100)*365, ((max(pNewCasesB$y13)/mean(pTotalIDUB$y13))*100)*365, ((max(pNewCasesB$y14)/mean(pTotalIDUB$y14))*100)*365, ((max(pNewCasesB$y15)/mean(pTotalIDUB$y15))*100)*365, ((max(pNewCasesB$y16)/mean(pTotalIDUB$y16))*100)*365, ((max(pNewCasesB$y17)/mean(pTotalIDUB$y17))*100)*365, ((max(pNewCasesB$y18)/mean(pTotalIDUB$y18))*100)*365, ((max(pNewCasesB$y19)/mean(pTotalIDUB$y19))*100)*365, ((max(pNewCasesB$y20)/mean(pTotalIDUB$y20))*100)*365, ((max(pNewCasesB$y21)/mean(pTotalIDUB$y21))*100)*365, ((max(pNewCasesB$y22)/mean(pTotalIDUB$y22))*100)*365, ((max(pNewCasesB$y23)/mean(pTotalIDUB$y23))*100)*365, ((max(pNewCasesB$y24)/mean(pTotalIDUB$y24))*100)*365, ((max(pNewCasesB$y25)/mean(pTotalIDUB$y25))*100)*365, ((max(pNewCasesB$y26)/mean(pTotalIDUB$y26))*100)*365, ((max(pNewCasesB$y27)/mean(pTotalIDUB$y27))*100)*365, ((max(pNewCasesB$y28)/mean(pTotalIDUB$y28))*100)*365, ((max(pNewCasesB$y29)/mean(pTotalIDUB$y29))*100)*365, ((max(pNewCasesB$y30)/mean(pTotalIDUB$y30))*100)*365)
#HCVB$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
#HCVB$Description <- c("OST improved and increased to 15000 per year")

#HCVC <- data.frame("IncidenceIDU"=c(((mean(pNewCasesC$y6)/mean(pTotalIDUC$y6))*100)*365, ((mean(pNewCasesC$y7)/mean(pTotalIDUC$y7))*100)*365, ((mean(pNewCasesC$y8)/mean(pTotalIDUC$y8))*100)*365, ((mean(pNewCasesC$y9)/mean(pTotalIDUC$y9))*100)*365, ((mean(pNewCasesC$y10)/mean(pTotalIDUC$y10))*100)*365, ((mean(pNewCasesC$y11)/mean(pTotalIDUC$y11))*100)*365, ((mean(pNewCasesC$y12)/mean(pTotalIDUC$y12))*100)*365, ((mean(pNewCasesC$y13)/mean(pTotalIDUC$y13))*100)*365, ((mean(pNewCasesC$y14)/mean(pTotalIDUC$y14))*100)*365, ((mean(pNewCasesC$y15)/mean(pTotalIDUC$y15))*100)*365, ((mean(pNewCasesC$y16)/mean(pTotalIDUC$y16))*100)*365, ((mean(pNewCasesC$y17)/mean(pTotalIDUC$y17))*100)*365, ((mean(pNewCasesC$y18)/mean(pTotalIDUC$y18))*100)*365, ((mean(pNewCasesC$y19)/mean(pTotalIDUC$y19))*100)*365, ((mean(pNewCasesC$y20)/mean(pTotalIDUC$y20))*100)*365, ((mean(pNewCasesC$y21)/mean(pTotalIDUC$y21))*100)*365, ((mean(pNewCasesC$y22)/mean(pTotalIDUC$y22))*100)*365, ((mean(pNewCasesC$y23)/mean(pTotalIDUC$y23))*100)*365, ((mean(pNewCasesC$y24)/mean(pTotalIDUC$y24))*100)*365, ((mean(pNewCasesC$y25)/mean(pTotalIDUC$y25))*100)*365, ((mean(pNewCasesC$y26)/mean(pTotalIDUC$y26))*100)*365, ((mean(pNewCasesC$y27)/mean(pTotalIDUC$y27))*100)*365, ((mean(pNewCasesC$y28)/mean(pTotalIDUC$y28))*100)*365, ((mean(pNewCasesC$y29)/mean(pTotalIDUC$y29))*100)*365, ((mean(pNewCasesC$y30)/mean(pTotalIDUC$y30))*100)*365))
#HCVC$IncidenceFloor <- c(((min(pNewCasesC$y6)/mean(pTotalIDUC$y6))*100)*365, ((min(pNewCasesC$y7)/mean(pTotalIDUC$y7))*100)*365, ((min(pNewCasesC$y8)/mean(pTotalIDUC$y8))*100)*365, ((min(pNewCasesC$y9)/mean(pTotalIDUC$y9))*100)*365, ((min(pNewCasesC$y10)/mean(pTotalIDUC$y10))*100)*365, ((min(pNewCasesC$y11)/mean(pTotalIDUC$y11))*100)*365, ((min(pNewCasesC$y12)/mean(pTotalIDUC$y12))*100)*365, ((min(pNewCasesC$y13)/mean(pTotalIDUC$y13))*100)*365, ((min(pNewCasesC$y14)/mean(pTotalIDUC$y14))*100)*365, ((min(pNewCasesC$y15)/mean(pTotalIDUC$y15))*100)*365, ((min(pNewCasesC$y16)/mean(pTotalIDUC$y16))*100)*365, ((min(pNewCasesC$y17)/mean(pTotalIDUC$y17))*100)*365, ((min(pNewCasesC$y18)/mean(pTotalIDUC$y18))*100)*365, ((min(pNewCasesC$y19)/mean(pTotalIDUC$y19))*100)*365, ((min(pNewCasesC$y20)/mean(pTotalIDUC$y20))*100)*365, ((min(pNewCasesC$y21)/mean(pTotalIDUC$y21))*100)*365, ((min(pNewCasesC$y22)/mean(pTotalIDUC$y22))*100)*365, ((min(pNewCasesC$y23)/mean(pTotalIDUC$y23))*100)*365, ((min(pNewCasesC$y24)/mean(pTotalIDUC$y24))*100)*365, ((min(pNewCasesC$y25)/mean(pTotalIDUC$y25))*100)*365, ((min(pNewCasesC$y26)/mean(pTotalIDUC$y26))*100)*365, ((min(pNewCasesC$y27)/mean(pTotalIDUC$y27))*100)*365, ((min(pNewCasesC$y28)/mean(pTotalIDUC$y28))*100)*365, ((min(pNewCasesC$y29)/mean(pTotalIDUC$y29))*100)*365, ((min(pNewCasesC$y30)/mean(pTotalIDUC$y30))*100)*365)
#HCVC$IncidenceCeiling <- c(((max(pNewCasesC$y6)/mean(pTotalIDUC$y6))*100)*365, ((max(pNewCasesC$y7)/mean(pTotalIDUC$y7))*100)*365, ((max(pNewCasesC$y8)/mean(pTotalIDUC$y8))*100)*365, ((max(pNewCasesC$y9)/mean(pTotalIDUC$y9))*100)*365, ((max(pNewCasesC$y10)/mean(pTotalIDUC$y10))*100)*365, ((max(pNewCasesC$y11)/mean(pTotalIDUC$y11))*100)*365, ((max(pNewCasesC$y12)/mean(pTotalIDUC$y12))*100)*365, ((max(pNewCasesC$y13)/mean(pTotalIDUC$y13))*100)*365, ((max(pNewCasesC$y14)/mean(pTotalIDUC$y14))*100)*365, ((max(pNewCasesC$y15)/mean(pTotalIDUC$y15))*100)*365, ((max(pNewCasesC$y16)/mean(pTotalIDUC$y16))*100)*365, ((max(pNewCasesC$y17)/mean(pTotalIDUC$y17))*100)*365, ((max(pNewCasesC$y18)/mean(pTotalIDUC$y18))*100)*365, ((max(pNewCasesC$y19)/mean(pTotalIDUC$y19))*100)*365, ((max(pNewCasesC$y20)/mean(pTotalIDUC$y20))*100)*365, ((max(pNewCasesC$y21)/mean(pTotalIDUC$y21))*100)*365, ((max(pNewCasesC$y22)/mean(pTotalIDUC$y22))*100)*365, ((max(pNewCasesC$y23)/mean(pTotalIDUC$y23))*100)*365, ((max(pNewCasesC$y24)/mean(pTotalIDUC$y24))*100)*365, ((max(pNewCasesC$y25)/mean(pTotalIDUC$y25))*100)*365, ((max(pNewCasesC$y26)/mean(pTotalIDUC$y26))*100)*365, ((max(pNewCasesC$y27)/mean(pTotalIDUC$y27))*100)*365, ((max(pNewCasesC$y28)/mean(pTotalIDUC$y28))*100)*365, ((max(pNewCasesC$y29)/mean(pTotalIDUC$y29))*100)*365, ((max(pNewCasesC$y30)/mean(pTotalIDUC$y30))*100)*365)
#HCVC$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
#HCVC$Description <- c("OST reduced to 0 per year")
...
HCVB$Description <- c("OST: intermediate scenario")#c("OST improved and increased to all PWID")
...
HCVC$Description <- c("OST: optimistic scenario")#c("OST retained at 1400 opioid users per year without improvement")
...
PlotLegend <- ggplot(data=incHCVIDU, aes(x=Year, y=IncidenceIDU, group=Description, col=Description, linetype=Description)) + geom_errorbar(aes(ymin=IncidenceFloor, ymax=IncidenceCeiling), width=.1) + geom_line(aes(linetype=Description, color=Description)) + geom_point(aes(shape=Description), size=3.5) + scale_linetype_manual(values=c("dotted", "twodash", "longdash", "solid", "dotdash")) + scale_shape_manual(values=c(1, 2, 17, 19, 15))  + ylab("HCV incidence\n among PWID") + geom_vline(xintercept=c(5), linetype="dotted") + scale_color_manual(values=c("#000000", "#000000", "#003366", "#660000", "#006633")) + ylim(0, 30) + geom_point(data=HCVEvan, mapping=aes(x=Year, y=IncidenceIDU, shape=Description), size=3.5) + geom_errorbar(data=HCVEvan, mapping=aes(ymin=IncidenceIDU-IncidenceIDUCI, ymax=IncidenceIDU+IncidenceIDUCI), colour="black", width=.1) + geom_point(data=HCVStopc, mapping=aes(x=Year, y=IncidenceIDU, shape=Description), size=3.5) + ggtitle("A") + theme_bw() + theme(legend.position="right", text=element_text(size=19), legend.title=element_blank(), plot.title = element_text(hjust = -0.05, vjust=1), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.text.x = element_text(angle = 40, hjust = 1))
...
HCVB$Year <- c("2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVB$Description <- c("OST: intermediate scenario")
...
HCVC$Year <- c("2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVC$Description <- c("OST: optimistic scenario")

incHCVIDU <- rbind(HCVA, HCVB, HCVC)
PlotB <- ggplot(data=incHCVIDU, aes(x=Year, y=IncidenceIDU, group=Description, col=Description, linetype=Description)) + geom_errorbar(aes(ymin=IncidenceFloor, ymax=IncidenceCeiling), width=.1) + geom_line(aes(linetype=Description, color=Description)) + geom_point(aes(shape=Description), size=3.5) + scale_linetype_manual(values=c("longdash", "solid", "dotdash")) + scale_shape_manual(values=c(17, 19, 15)) + ylab("Annual new infections") + geom_vline(xintercept=c(5), linetype="dotted") + scale_color_manual(values=c("#003366", "#660000", "#006633")) + ylim(0, 2000) + ggtitle("B") + theme_bw() + theme(legend.position="right", text=element_text(size=19), legend.title=element_blank(), plot.title = element_text(hjust = -0.05, vjust=1), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.text.x = element_text(angle = 40, hjust = 1))
...
incHCVIDU <- rbind(HCVA, HCVB, HCVC)
PlotC <- ggplot(data=incHCVIDU, aes(x=Year, y=IncidenceIDU, group=Description, col=Description, linetype=Description)) + geom_errorbar(aes(ymin=IncidenceFloor, ymax=IncidenceCeiling), width=.1) + geom_line(aes(linetype=Description, color=Description)) + geom_point(aes(shape=Description), size=3.5) + scale_linetype_manual(values=c("longdash", "solid", "dotdash")) + scale_shape_manual(values=c(17, 19, 15)) + ylab("Average number of people with\n HCV Ab+") + geom_vline(xintercept=c(5), linetype="dotted") + scale_color_manual(values=c("#003366", "#660000", "#006633")) + ylim(0, 10000) + ggtitle("C") + theme_bw() + theme(legend.position="right", text=element_text(size=19), legend.title=element_blank(), plot.title = element_text(hjust = -0.05, vjust=1), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.text.x = element_text(angle = 40, hjust = 1))
...
incHCVIDU <- rbind(HCVA, HCVB, HCVC)
PlotD <- ggplot(data=incHCVIDU, aes(x=Year, y=IncidenceIDU, group=Description, col=Description, linetype=Description)) + geom_errorbar(aes(ymin=IncidenceFloor, ymax=IncidenceCeiling), width=.1) + geom_line(aes(linetype=Description, color=Description)) + geom_point(aes(shape=Description), size=3.5) + scale_linetype_manual(values=c("longdash", "solid", "dotdash")) + scale_shape_manual(values=c(17, 19, 15)) + ylab("Average number of people with\n HCV RNA+") + geom_vline(xintercept=c(13), linetype="dotted") + scale_color_manual(values=c("#003366", "#660000", "#006633")) + ylim(0, 10000) + ggtitle("D") + theme_bw() + theme(legend.position="right", text=element_text(size=19), legend.title=element_blank(), plot.title = element_text(hjust = -0.05, vjust=1), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.text.x = element_text(angle = 40, hjust = 1))
...
HCVAp$Year <- c("2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVAp$Description <- c("OST intermediate scenario")#c("maintained number of DAA treatments")
...
HCVBp$Description <- c("OST optimistic scenario")#c("DAA treatments increased to 5000 per year")
...
HCVCp$Description <- c("OST pessimistic scenario")#c("DAA treatments reduced to 0 per year")
...
PlotB <-  ggplot(data=prevHCVAll, aes(x=Year, y=IncidenceIDU, group=Description, col=Description, linetype=Description)) + geom_errorbar(aes(ymin=IncidenceFloor, ymax=IncidenceCeiling), colour="black", width=.1) + geom_line(aes(linetype=Description, color=Description)) + geom_point(aes(shape=Description), size=3.5) + scale_shape_manual(values=c(3, 15, 19, 17))  + scale_linetype_manual(values=c("dotted", "dotdash", "solid", "longdash")) + ylab("HCV Ab prevalence\n among total prison population") + scale_color_manual(values=c( "#000000", "#006633", "#660000", "#003366")) + ylim(0, 50) + geom_vline(xintercept=c(5), linetype="dotted") + ggtitle("B") + theme_bw() + theme(legend.position="right", text=element_text(size=19), legend.title=element_blank(), plot.title = element_text(hjust = -0.05, vjust=1), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.text.x = element_text(angle = 40, hjust = 1))
