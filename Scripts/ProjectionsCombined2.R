...
#  pTotalHCVRNAA <- rbind(pTotalHCVRNAA, ptHCVRNATmp)
  ...
  ptHCVTmp <- data.frame(y6=NA, y7=NA, y8=NA, y9=NA, y10=NA, y11=NA, y12=NA, y13=NA, y14=NA, y15=NA, y16=NA, y17=NA, y18=NA, y19=NA, y20=NA, y21=NA, y22=NA, y23=NA, y24=NA, y25=NA, y26=NA, y27=NA, y28=NA, y29=NA, y30=NA)[numeric(0), ]
  ptHCVTmp[1,] <- 0
...
for (var in 1:10)
{
  #fileName <- paste("P:/SERP/Modelling/Evaluation_Modelling/HCV prison model/Results/dailyMoves", var, ".xls", sep="")
  #fileName <- paste("P:/SERP/Modelling/Evaluation_Modelling/HCV prison model/Results/outSet25.xls", sep="")
  fileName <- paste("/Users/neilarvinbretana/Desktop/Scenarios/Testing/results/outDON_", var, ".xls", sep="")
  tempFile <- read.csv(fileName, sep="\t",header=TRUE)
...
for (var in 1:10)
{
  #fileName <- paste("P:/SERP/Modelling/Evaluation_Modelling/HCV prison model/Results/dailyMoves", var, ".xls", sep="")
  #fileName <- paste("P:/SERP/Modelling/Evaluation_Modelling/HCV prison model/Results/outSet25.xls", sep="")
  fileName <- paste("/Users/neilarvinbretana/Desktop/Scenarios/Testing/results/outRD_", var, ".xls", sep="") #New infection Function/
  tempFile <- read.csv(fileName, sep="\t",header=TRUE)
...
#  pTotalNSPSumD <- rbind(pTotalNSPSumD, ptNSPTmp)
  ...
  ptHCVTmp$y29[1] <- mean(Y29$Pmin0+Y29$Pmin1+Y29$Pmin6+Y29$Pmin7+Y29$Pmed0+Y29$Pmed1+Y29$Pmed6+Y29$Pmed7+Y29$Pmax0+Y29$Pmax1+Y29$Pmax6+Y29$Pmax7)
  ptHCVTmp$y30[1] <- mean(Y30$Pmin0+Y30$Pmin1+Y30$Pmin6+Y30$Pmin7+Y30$Pmed0+Y30$Pmed1+Y30$Pmed6+Y30$Pmed7+Y30$Pmax0+Y30$Pmax1+Y30$Pmax6+Y30$Pmax7)
  pTotalHCVRNAD <- rbind(pTotalHCVRNAD, ptHCVTmp)
...
#  pTotalHCVabE <- rbind(pTotalHCVabE, ptHCVabTmp)
  ...
  ptHCVTmp$y29[1] <- mean(Y29$Pmin0+Y29$Pmin1+Y29$Pmin6+Y29$Pmin7+Y29$Pmed0+Y29$Pmed1+Y29$Pmed6+Y29$Pmed7+Y29$Pmax0+Y29$Pmax1+Y29$Pmax6+Y29$Pmax7)
  ptHCVTmp$y30[1] <- mean(Y30$Pmin0+Y30$Pmin1+Y30$Pmin6+Y30$Pmin7+Y30$Pmed0+Y30$Pmed1+Y30$Pmed6+Y30$Pmed7+Y30$Pmax0+Y30$Pmax1+Y30$Pmax6+Y30$Pmax7)
  pTotalHCVRNAE <- rbind(pTotalHCVRNAE, ptHCVTmp)
...
for (var in 1:10)
{
  #fileName <- paste("P:/SERP/Modelling/Evaluation_Modelling/HCV prison model/Results/dailyMoves", var, ".xls", sep="")
  #fileName <- paste("P:/SERP/Modelling/Evaluation_Modelling/HCV prison model/Results/outSet25.xls", sep="")
  fileName <- paste("/Users/neilarvinbretana/Desktop/Scenarios/Testing/results/outRDON_", var, ".xls", sep="")
  tempFile <- read.csv(fileName, sep="\t",header=TRUE)
...
HCVB$Description <- c("DAA(optimistic) + OST(intermediate)")#c("OST improved and increased to all PWID")
...
HCVC$Description <- c("DAA(optimistic) + OST(intermediate) + NSP(intermediate)")#c("OST retained at 1400 opioid users per year without improvement")

HCVD <- data.frame("IncidenceIDU"=c(((mean(pNewCasesD$y13)/mean(pEverIDUD$y13))*100)*365, ((mean(pNewCasesD$y14)/mean(pEverIDUD$y14))*100)*365, ((mean(pNewCasesD$y15)/mean(pEverIDUD$y15))*100)*365, ((mean(pNewCasesD$y16)/mean(pEverIDUD$y16))*100)*365, ((mean(pNewCasesD$y17)/mean(pEverIDUD$y17))*100)*365, ((mean(pNewCasesD$y18)/mean(pEverIDUD$y18))*100)*365, ((mean(pNewCasesD$y19)/mean(pEverIDUD$y19))*100)*365, ((mean(pNewCasesD$y20)/mean(pEverIDUD$y20))*100)*365, ((mean(pNewCasesD$y21)/mean(pEverIDUD$y21))*100)*365, ((mean(pNewCasesD$y22)/mean(pEverIDUD$y22))*100)*365, ((mean(pNewCasesD$y23)/mean(pEverIDUD$y23))*100)*365, ((mean(pNewCasesD$y24)/mean(pEverIDUD$y24))*100)*365, ((mean(pNewCasesD$y25)/mean(pEverIDUD$y25))*100)*365, ((mean(pNewCasesD$y26)/mean(pEverIDUD$y26))*100)*365, ((mean(pNewCasesD$y27)/mean(pEverIDUD$y27))*100)*365, ((mean(pNewCasesD$y28)/mean(pEverIDUD$y28))*100)*365, ((mean(pNewCasesD$y29)/mean(pEverIDUD$y29))*100)*365, ((mean(pNewCasesD$y30)/mean(pEverIDUD$y30))*100)*365))
HCVD$IncidenceFloor <- c(((min(pNewCasesD$y13)/mean(pEverIDUD$y13))*100)*365, ((min(pNewCasesD$y14)/mean(pEverIDUD$y14))*100)*365, ((min(pNewCasesD$y15)/mean(pEverIDUD$y15))*100)*365, ((min(pNewCasesD$y16)/mean(pEverIDUD$y16))*100)*365, ((min(pNewCasesD$y17)/mean(pEverIDUD$y17))*100)*365, ((min(pNewCasesD$y18)/mean(pEverIDUD$y18))*100)*365, ((min(pNewCasesD$y19)/mean(pEverIDUD$y19))*100)*365, ((min(pNewCasesD$y20)/mean(pEverIDUD$y20))*100)*365, ((min(pNewCasesD$y21)/mean(pEverIDUD$y21))*100)*365, ((min(pNewCasesD$y22)/mean(pEverIDUD$y22))*100)*365, ((min(pNewCasesD$y23)/mean(pEverIDUD$y23))*100)*365, ((min(pNewCasesD$y24)/mean(pEverIDUD$y24))*100)*365, ((min(pNewCasesD$y25)/mean(pEverIDUD$y25))*100)*365, ((min(pNewCasesD$y26)/mean(pEverIDUD$y26))*100)*365, ((min(pNewCasesD$y27)/mean(pEverIDUD$y27))*100)*365, ((min(pNewCasesD$y28)/mean(pEverIDUD$y28))*100)*365, ((min(pNewCasesD$y29)/mean(pEverIDUD$y29))*100)*365, ((min(pNewCasesD$y30)/mean(pEverIDUD$y30))*100)*365)
HCVD$IncidenceCeiling <- c(((max(pNewCasesD$y13)/mean(pEverIDUD$y13))*100)*365, ((max(pNewCasesD$y14)/mean(pEverIDUD$y14))*100)*365, ((max(pNewCasesD$y15)/mean(pEverIDUD$y15))*100)*365, ((max(pNewCasesD$y16)/mean(pEverIDUD$y16))*100)*365, ((max(pNewCasesD$y17)/mean(pEverIDUD$y17))*100)*365, ((max(pNewCasesD$y18)/mean(pEverIDUD$y18))*100)*365, ((max(pNewCasesD$y19)/mean(pEverIDUD$y19))*100)*365, ((max(pNewCasesD$y20)/mean(pEverIDUD$y20))*100)*365, ((max(pNewCasesD$y21)/mean(pEverIDUD$y21))*100)*365, ((max(pNewCasesD$y22)/mean(pEverIDUD$y22))*100)*365, ((max(pNewCasesD$y23)/mean(pEverIDUD$y23))*100)*365, ((max(pNewCasesD$y24)/mean(pEverIDUD$y24))*100)*365, ((max(pNewCasesD$y25)/mean(pEverIDUD$y25))*100)*365, ((max(pNewCasesD$y26)/mean(pEverIDUD$y26))*100)*365, ((max(pNewCasesD$y27)/mean(pEverIDUD$y27))*100)*365, ((max(pNewCasesD$y28)/mean(pEverIDUD$y28))*100)*365, ((max(pNewCasesD$y29)/mean(pEverIDUD$y29))*100)*365, ((max(pNewCasesD$y30)/mean(pEverIDUD$y30))*100)*365)
HCVD$Year <- c("2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVD$Description <- c("DAA(optimistic) + Reduction(intermediate)")

HCVE <- data.frame("IncidenceIDU"=c(((mean(pNewCasesE$y13)/mean(pEverIDUE$y13))*100)*365, ((mean(pNewCasesE$y14)/mean(pEverIDUE$y14))*100)*365, ((mean(pNewCasesE$y15)/mean(pEverIDUE$y15))*100)*365, ((mean(pNewCasesE$y16)/mean(pEverIDUE$y16))*100)*365, ((mean(pNewCasesE$y17)/mean(pEverIDUE$y17))*100)*365, ((mean(pNewCasesE$y18)/mean(pEverIDUE$y18))*100)*365, ((mean(pNewCasesE$y19)/mean(pEverIDUE$y19))*100)*365, ((mean(pNewCasesE$y20)/mean(pEverIDUE$y20))*100)*365, ((mean(pNewCasesE$y21)/mean(pEverIDUE$y21))*100)*365, ((mean(pNewCasesE$y22)/mean(pEverIDUE$y22))*100)*365, ((mean(pNewCasesE$y23)/mean(pEverIDUE$y23))*100)*365, ((mean(pNewCasesE$y24)/mean(pEverIDUE$y24))*100)*365, ((mean(pNewCasesE$y25)/mean(pEverIDUE$y25))*100)*365, ((mean(pNewCasesE$y26)/mean(pEverIDUE$y26))*100)*365, ((mean(pNewCasesE$y27)/mean(pEverIDUE$y27))*100)*365, ((mean(pNewCasesE$y28)/mean(pEverIDUE$y28))*100)*365, ((mean(pNewCasesE$y29)/mean(pEverIDUE$y29))*100)*365, ((mean(pNewCasesE$y30)/mean(pEverIDUE$y30))*100)*365))
HCVE$IncidenceFloor <- c(((min(pNewCasesE$y13)/mean(pEverIDUE$y13))*100)*365, ((min(pNewCasesE$y14)/mean(pEverIDUE$y14))*100)*365, ((min(pNewCasesE$y15)/mean(pEverIDUE$y15))*100)*365, ((min(pNewCasesE$y16)/mean(pEverIDUE$y16))*100)*365, ((min(pNewCasesE$y17)/mean(pEverIDUE$y17))*100)*365, ((min(pNewCasesE$y18)/mean(pEverIDUE$y18))*100)*365, ((min(pNewCasesE$y19)/mean(pEverIDUE$y19))*100)*365, ((min(pNewCasesE$y20)/mean(pEverIDUE$y20))*100)*365, ((min(pNewCasesE$y21)/mean(pEverIDUE$y21))*100)*365, ((min(pNewCasesE$y22)/mean(pEverIDUE$y22))*100)*365, ((min(pNewCasesE$y23)/mean(pEverIDUE$y23))*100)*365, ((min(pNewCasesE$y24)/mean(pEverIDUE$y24))*100)*365, ((min(pNewCasesE$y25)/mean(pEverIDUE$y25))*100)*365, ((min(pNewCasesE$y26)/mean(pEverIDUE$y26))*100)*365, ((min(pNewCasesE$y27)/mean(pEverIDUE$y27))*100)*365, ((min(pNewCasesE$y28)/mean(pEverIDUE$y28))*100)*365, ((min(pNewCasesE$y29)/mean(pEverIDUE$y29))*100)*365, ((min(pNewCasesE$y30)/mean(pEverIDUE$y30))*100)*365)
HCVE$IncidenceCeiling <- c(((max(pNewCasesE$y13)/mean(pEverIDUE$y13))*100)*365, ((max(pNewCasesE$y14)/mean(pEverIDUE$y14))*100)*365, ((max(pNewCasesE$y15)/mean(pEverIDUE$y15))*100)*365, ((max(pNewCasesE$y16)/mean(pEverIDUE$y16))*100)*365, ((max(pNewCasesE$y17)/mean(pEverIDUE$y17))*100)*365, ((max(pNewCasesE$y18)/mean(pEverIDUE$y18))*100)*365, ((max(pNewCasesE$y19)/mean(pEverIDUE$y19))*100)*365, ((max(pNewCasesE$y20)/mean(pEverIDUE$y20))*100)*365, ((max(pNewCasesE$y21)/mean(pEverIDUE$y21))*100)*365, ((max(pNewCasesE$y22)/mean(pEverIDUE$y22))*100)*365, ((max(pNewCasesE$y23)/mean(pEverIDUE$y23))*100)*365, ((max(pNewCasesE$y24)/mean(pEverIDUE$y24))*100)*365, ((max(pNewCasesE$y25)/mean(pEverIDUE$y25))*100)*365, ((max(pNewCasesE$y26)/mean(pEverIDUE$y26))*100)*365, ((max(pNewCasesE$y27)/mean(pEverIDUE$y27))*100)*365, ((max(pNewCasesE$y28)/mean(pEverIDUE$y28))*100)*365, ((max(pNewCasesE$y29)/mean(pEverIDUE$y29))*100)*365, ((max(pNewCasesE$y30)/mean(pEverIDUE$y30))*100)*365)
HCVE$Year <- c("2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVE$Description <- c("DAA(optimistic) + OST(intermediate) + Reduction(intermediate)")#c("OST retained at 1400 opioid users per year without improvement")

HCVF <- data.frame("IncidenceIDU"=c(((mean(pNewCasesF$y13)/mean(pEverIDUF$y13))*100)*365, ((mean(pNewCasesF$y14)/mean(pEverIDUF$y14))*100)*365, ((mean(pNewCasesF$y15)/mean(pEverIDUF$y15))*100)*365, ((mean(pNewCasesF$y16)/mean(pEverIDUF$y16))*100)*365, ((mean(pNewCasesF$y17)/mean(pEverIDUF$y17))*100)*365, ((mean(pNewCasesF$y18)/mean(pEverIDUF$y18))*100)*365, ((mean(pNewCasesF$y19)/mean(pEverIDUF$y19))*100)*365, ((mean(pNewCasesF$y20)/mean(pEverIDUF$y20))*100)*365, ((mean(pNewCasesF$y21)/mean(pEverIDUF$y21))*100)*365, ((mean(pNewCasesF$y22)/mean(pEverIDUF$y22))*100)*365, ((mean(pNewCasesF$y23)/mean(pEverIDUF$y23))*100)*365, ((mean(pNewCasesF$y24)/mean(pEverIDUF$y24))*100)*365, ((mean(pNewCasesF$y25)/mean(pEverIDUF$y25))*100)*365, ((mean(pNewCasesF$y26)/mean(pEverIDUF$y26))*100)*365, ((mean(pNewCasesF$y27)/mean(pEverIDUF$y27))*100)*365, ((mean(pNewCasesF$y28)/mean(pEverIDUF$y28))*100)*365, ((mean(pNewCasesF$y29)/mean(pEverIDUF$y29))*100)*365, ((mean(pNewCasesF$y30)/mean(pEverIDUF$y30))*100)*365))
HCVF$IncidenceFloor <- c(((min(pNewCasesF$y13)/mean(pEverIDUF$y13))*100)*365, ((min(pNewCasesF$y14)/mean(pEverIDUF$y14))*100)*365, ((min(pNewCasesF$y15)/mean(pEverIDUF$y15))*100)*365, ((min(pNewCasesF$y16)/mean(pEverIDUF$y16))*100)*365, ((min(pNewCasesF$y17)/mean(pEverIDUF$y17))*100)*365, ((min(pNewCasesF$y18)/mean(pEverIDUF$y18))*100)*365, ((min(pNewCasesF$y19)/mean(pEverIDUF$y19))*100)*365, ((min(pNewCasesF$y20)/mean(pEverIDUF$y20))*100)*365, ((min(pNewCasesF$y21)/mean(pEverIDUF$y21))*100)*365, ((min(pNewCasesF$y22)/mean(pEverIDUF$y22))*100)*365, ((min(pNewCasesF$y23)/mean(pEverIDUF$y23))*100)*365, ((min(pNewCasesF$y24)/mean(pEverIDUF$y24))*100)*365, ((min(pNewCasesF$y25)/mean(pEverIDUF$y25))*100)*365, ((min(pNewCasesF$y26)/mean(pEverIDUF$y26))*100)*365, ((min(pNewCasesF$y27)/mean(pEverIDUF$y27))*100)*365, ((min(pNewCasesF$y28)/mean(pEverIDUF$y28))*100)*365, ((min(pNewCasesF$y29)/mean(pEverIDUF$y29))*100)*365, ((min(pNewCasesF$y30)/mean(pEverIDUF$y30))*100)*365)
HCVF$IncidenceCeiling <- c(((max(pNewCasesF$y13)/mean(pEverIDUF$y13))*100)*365, ((max(pNewCasesF$y14)/mean(pEverIDUF$y14))*100)*365, ((max(pNewCasesF$y15)/mean(pEverIDUF$y15))*100)*365, ((max(pNewCasesF$y16)/mean(pEverIDUF$y16))*100)*365, ((max(pNewCasesF$y17)/mean(pEverIDUF$y17))*100)*365, ((max(pNewCasesF$y18)/mean(pEverIDUF$y18))*100)*365, ((max(pNewCasesF$y19)/mean(pEverIDUF$y19))*100)*365, ((max(pNewCasesF$y20)/mean(pEverIDUF$y20))*100)*365, ((max(pNewCasesF$y21)/mean(pEverIDUF$y21))*100)*365, ((max(pNewCasesF$y22)/mean(pEverIDUF$y22))*100)*365, ((max(pNewCasesF$y23)/mean(pEverIDUF$y23))*100)*365, ((max(pNewCasesF$y24)/mean(pEverIDUF$y24))*100)*365, ((max(pNewCasesF$y25)/mean(pEverIDUF$y25))*100)*365, ((max(pNewCasesF$y26)/mean(pEverIDUF$y26))*100)*365, ((max(pNewCasesF$y27)/mean(pEverIDUF$y27))*100)*365, ((max(pNewCasesF$y28)/mean(pEverIDUF$y28))*100)*365, ((max(pNewCasesF$y29)/mean(pEverIDUF$y29))*100)*365, ((max(pNewCasesF$y30)/mean(pEverIDUF$y30))*100)*365)
HCVF$Year <- c("2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVF$Description <- c("DAA(optimistic) + OST(intermediate) + NSP(intermediate) \n+ Reduction(intermediate)")#c("OST retained at 1400 opioid users per year without improvement")

HCVStopc <- data.frame("IncidenceIDU"=c(17.8))
HCVStopc$IncidenceIDUCI <- c(17.8)
HCVStopc$Year <- c("2015")
HCVStopc$Description <- c("2015 reported HCV incidence") #stop-c

HCVEvan <- data.frame("IncidenceIDU"=c(13.3))
HCVEvan$IncidenceIDUCI <- c(13.3-8.64)
HCVEvan$Year <- c("2013")
HCVEvan$Description <- c("2013 reported HCV incidence") #hits-p
...
incHCVIDU <- rbind(HCVA, HCVB, HCVC, HCVD, HCVE, HCVF)
PlotA <- ggplot(data=incHCVIDU, aes(x=Year, y=IncidenceIDU, group=Description, col=Description, linetype=Description)) + geom_errorbar(aes(ymin=IncidenceFloor, ymax=IncidenceCeiling), width=.1) + geom_line(aes(linetype=Description, color=Description)) + geom_point(aes(shape=Description), size=3.5) + scale_linetype_manual(values=c("dashed", "dotted", "solid", "longdash", "twodash", "dotted", "dotdash", "solid")) + scale_shape_manual(values=c(1, 2, 16, 17, 18, 3, 21, 15))  + ylab("HCV incidence\n among PWID") + geom_vline(xintercept=c(5), linetype="dotted") + scale_color_manual(values=c("#000000", "#000000", "coral", "chocolate", "cadetblue", "brown", "blue", "#006633")) + ylim(0, 25) + geom_point(data=HCVEvan, mapping=aes(x=Year, y=IncidenceIDU, shape=Description), size=4) + geom_errorbar(data=HCVEvan, mapping=aes(ymin=IncidenceIDU-IncidenceIDUCI, ymax=IncidenceIDU+IncidenceIDUCI), colour="black", width=.1) + geom_point(data=HCVStopc, mapping=aes(x=Year, y=IncidenceIDU, shape=Description), size=4) + ggtitle("A") + theme_bw() + theme(legend.position="right", text=element_text(size=19), legend.title=element_blank(), plot.title = element_text(hjust = -0.05, vjust=1), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.text.x = element_text(angle = 40, hjust = 1))
...
PL1 <- rbind(HCVB, HCVC, HCVE, HCVF)
PL2 <- rbind(HCVA, HCVD)
PlotLegend1 <- ggplot(data=PL1, aes(x=Year, y=IncidenceIDU, group=Description, col=Description, linetype=Description)) + geom_errorbar(aes(ymin=IncidenceFloor, ymax=IncidenceCeiling), width=.1) + geom_line(aes(linetype=Description, color=Description)) + geom_point(aes(shape=Description), size=3.5) + scale_linetype_manual(values=c("solid", "longdash", "twodash", "dotted")) + scale_shape_manual(values=c(16, 17, 18, 3))  + ylab("HCV incidence\n among PWID") + geom_vline(xintercept=c(5), linetype="dotted") + scale_color_manual(values=c("coral", "chocolate", "cadetblue", "brown")) + ylim(0, 25) + ggtitle("A") + theme_bw() + theme(legend.position="right", text=element_text(size=19), legend.title=element_blank(), plot.title = element_text(hjust = -0.05, vjust=1), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.text.x = element_text(angle = 40, hjust = 1))
PlotLegend2 <- ggplot(data=PL2, aes(x=Year, y=IncidenceIDU, group=Description, col=Description, linetype=Description)) + geom_errorbar(aes(ymin=IncidenceFloor, ymax=IncidenceCeiling), width=.1) + geom_line(aes(linetype=Description, color=Description)) + geom_point(aes(shape=Description), size=3.5) + scale_linetype_manual(values=c("dashed", "dotted", "dotdash", "solid")) + scale_shape_manual(values=c(1, 2, 21, 15))  + ylab("HCV incidence\n among PWID") + geom_vline(xintercept=c(5), linetype="dotted") + scale_color_manual(values=c("#000000","#000000","blue", "#006633")) + ylim(0, 25) + geom_point(data=HCVEvan, mapping=aes(x=Year, y=IncidenceIDU, shape=Description), size=4) + geom_errorbar(data=HCVEvan, mapping=aes(ymin=IncidenceIDU-IncidenceIDUCI, ymax=IncidenceIDU+IncidenceIDUCI), colour="black", width=.1) + geom_point(data=HCVStopc, mapping=aes(x=Year, y=IncidenceIDU, shape=Description), size=4) + ggtitle("A") + theme_bw() + theme(legend.position="right", text=element_text(size=19), legend.title=element_blank(), plot.title = element_text(hjust = -0.05, vjust=1), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.text.x = element_text(angle = 40, hjust = 1))
...
HCVB$Year <- c("2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVB$Description <- c("DAA(optimistic) + OST(intermediate)")
...
HCVC$Year <- c("2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVC$Description <- c("DAA(optimistic) + OST(intermediate) + NSP(intermediate)")

HCVD <- data.frame("IncidenceIDU"=c(mean(pNewCasesSumD$y13), mean(pNewCasesSumD$y14), mean(pNewCasesSumD$y15), mean(pNewCasesSumD$y16), mean(pNewCasesSumD$y17), mean(pNewCasesSumD$y18), mean(pNewCasesSumD$y19), mean(pNewCasesSumD$y20), mean(pNewCasesSumD$y21), mean(pNewCasesSumD$y22), mean(pNewCasesSumD$y23), mean(pNewCasesSumD$y24), mean(pNewCasesSumD$y25), mean(pNewCasesSumD$y26), mean(pNewCasesSumD$y27), mean(pNewCasesSumD$y28), mean(pNewCasesSumD$y29), mean(pNewCasesSumD$y30)))
HCVD$IncidenceFloor <- c(min(pNewCasesSumD$y13), min(pNewCasesSumD$y14), min(pNewCasesSumD$y15), min(pNewCasesSumD$y16), min(pNewCasesSumD$y17), min(pNewCasesSumD$y18), min(pNewCasesSumD$y19), min(pNewCasesSumD$y20), min(pNewCasesSumD$y21), min(pNewCasesSumD$y22), min(pNewCasesSumD$y23), min(pNewCasesSumD$y24), min(pNewCasesSumD$y25), min(pNewCasesSumD$y26), min(pNewCasesSumD$y27), min(pNewCasesSumD$y28), min(pNewCasesSumD$y29), min(pNewCasesSumD$y30))
HCVD$IncidenceCeiling <- c(max(pNewCasesSumD$y13), max(pNewCasesSumD$y14), max(pNewCasesSumD$y15), max(pNewCasesSumD$y16), max(pNewCasesSumD$y17), max(pNewCasesSumD$y18), max(pNewCasesSumD$y19), max(pNewCasesSumD$y20), max(pNewCasesSumD$y21), max(pNewCasesSumD$y22), max(pNewCasesSumD$y23), max(pNewCasesSumD$y24), max(pNewCasesSumD$y25), max(pNewCasesSumD$y26), max(pNewCasesSumD$y27), max(pNewCasesSumD$y28), max(pNewCasesSumD$y29), max(pNewCasesSumD$y30))
HCVD$Year <- c("2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVD$Description <- c("DAA(optimistic) + Reduction(intermediate)")

HCVE <- data.frame("IncidenceIDU"=c(mean(pNewCasesSumE$y13), mean(pNewCasesSumE$y14), mean(pNewCasesSumE$y15), mean(pNewCasesSumE$y16), mean(pNewCasesSumE$y17), mean(pNewCasesSumE$y18), mean(pNewCasesSumE$y19), mean(pNewCasesSumE$y20), mean(pNewCasesSumE$y21), mean(pNewCasesSumE$y22), mean(pNewCasesSumE$y23), mean(pNewCasesSumE$y24), mean(pNewCasesSumE$y25), mean(pNewCasesSumE$y26), mean(pNewCasesSumE$y27), mean(pNewCasesSumE$y28), mean(pNewCasesSumE$y29), mean(pNewCasesSumE$y30)))
HCVE$IncidenceFloor <- c(min(pNewCasesSumE$y13), min(pNewCasesSumE$y14), min(pNewCasesSumE$y15), min(pNewCasesSumE$y16), min(pNewCasesSumE$y17), min(pNewCasesSumE$y18), min(pNewCasesSumE$y19), min(pNewCasesSumE$y20), min(pNewCasesSumE$y21), min(pNewCasesSumE$y22), min(pNewCasesSumE$y23), min(pNewCasesSumE$y24), min(pNewCasesSumE$y25), min(pNewCasesSumE$y26), min(pNewCasesSumE$y27), min(pNewCasesSumE$y28), min(pNewCasesSumE$y29), min(pNewCasesSumE$y30))
HCVE$IncidenceCeiling <- c(max(pNewCasesSumE$y13), max(pNewCasesSumE$y14), max(pNewCasesSumE$y15), max(pNewCasesSumE$y16), max(pNewCasesSumE$y17), max(pNewCasesSumE$y18), max(pNewCasesSumE$y19), max(pNewCasesSumE$y20), max(pNewCasesSumE$y21), max(pNewCasesSumE$y22), max(pNewCasesSumE$y23), max(pNewCasesSumE$y24), max(pNewCasesSumE$y25), max(pNewCasesSumE$y26), max(pNewCasesSumE$y27), max(pNewCasesSumE$y28), max(pNewCasesSumE$y29), max(pNewCasesSumE$y30))
HCVE$Year <- c("2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVE$Description <- c("DAA(optimistic) + OST(intermediate) + Reduction(intermediate)")

HCVF <- data.frame("IncidenceIDU"=c(mean(pNewCasesSumF$y13), mean(pNewCasesSumF$y14), mean(pNewCasesSumF$y15), mean(pNewCasesSumF$y16), mean(pNewCasesSumF$y17), mean(pNewCasesSumF$y18), mean(pNewCasesSumF$y19), mean(pNewCasesSumF$y20), mean(pNewCasesSumF$y21), mean(pNewCasesSumF$y22), mean(pNewCasesSumF$y23), mean(pNewCasesSumF$y24), mean(pNewCasesSumF$y25), mean(pNewCasesSumF$y26), mean(pNewCasesSumF$y27), mean(pNewCasesSumF$y28), mean(pNewCasesSumF$y29), mean(pNewCasesSumF$y30)))
...
HCVF$IncidenceCeiling <- c(max(pNewCasesSumF$y13), max(pNewCasesSumF$y14), max(pNewCasesSumF$y15), max(pNewCasesSumF$y16), max(pNewCasesSumF$y17), max(pNewCasesSumF$y18), max(pNewCasesSumF$y19), max(pNewCasesSumF$y20), max(pNewCasesSumF$y21), max(pNewCasesSumF$y22), max(pNewCasesSumF$y23), max(pNewCasesSumF$y24), max(pNewCasesSumF$y25), max(pNewCasesSumF$y26), max(pNewCasesSumF$y27), max(pNewCasesSumF$y28), max(pNewCasesSumF$y29), max(pNewCasesSumF$y30))
HCVF$Year <- c("2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVF$Description <- c("DAA(optimistic) + OST(intermediate) + NSP(intermediate) + Reduction(intermediate)")

incHCVIDU <- rbind(HCVA, HCVB, HCVC, HCVD, HCVE, HCVF)
PlotB <- ggplot(data=incHCVIDU, aes(x=Year, y=IncidenceIDU, group=Description, col=Description, linetype=Description)) + geom_errorbar(aes(ymin=IncidenceFloor, ymax=IncidenceCeiling), width=.1) + geom_line(aes(linetype=Description, color=Description)) + geom_point(aes(shape=Description), size=3.5) + scale_linetype_manual(values=c("solid", "longdash", "twodash", "dotted", "dotdash", "solid")) + scale_shape_manual(values=c(16, 17, 18, 3, 21, 15)) + ylab("Annual new infections") + geom_vline(xintercept=c(5), linetype="dotted") + scale_color_manual(values=c("coral", "chocolate", "cadetblue", "brown", "blue", "#006633")) + ylim(0, 2000) + ggtitle("B") + theme_bw() + theme(legend.position="right", text=element_text(size=19), legend.title=element_blank(), plot.title = element_text(hjust = -0.05, vjust=1), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.text.x = element_text(angle = 40, hjust = 1))
...
HCVD <- data.frame("IncidenceIDU"=c(mean(pTotalHCVabD$y13), mean(pTotalHCVabD$y14), mean(pTotalHCVabD$y15), mean(pTotalHCVabD$y16), mean(pTotalHCVabD$y17), mean(pTotalHCVabD$y18), mean(pTotalHCVabD$y19), mean(pTotalHCVabD$y20), mean(pTotalHCVabD$y21), mean(pTotalHCVabD$y22), mean(pTotalHCVabD$y23), mean(pTotalHCVabD$y24), mean(pTotalHCVabD$y25), mean(pTotalHCVabD$y26), mean(pTotalHCVabD$y27), mean(pTotalHCVabD$y28), mean(pTotalHCVabD$y29), mean(pTotalHCVabD$y30)))
HCVD$IncidenceFloor <- c(min(pTotalHCVabD$y13), min(pTotalHCVabD$y14), min(pTotalHCVabD$y15), min(pTotalHCVabD$y16), min(pTotalHCVabD$y17), min(pTotalHCVabD$y18), min(pTotalHCVabD$y19), min(pTotalHCVabD$y20), min(pTotalHCVabD$y21), min(pTotalHCVabD$y22), min(pTotalHCVabD$y23), min(pTotalHCVabD$y24), min(pTotalHCVabD$y25), min(pTotalHCVabD$y26), min(pTotalHCVabD$y27), min(pTotalHCVabD$y28), min(pTotalHCVabD$y29), min(pTotalHCVabD$y30))
HCVD$IncidenceCeiling <- c(max(pTotalHCVabD$y13), max(pTotalHCVabD$y14), max(pTotalHCVabD$y15), max(pTotalHCVabD$y16), max(pTotalHCVabD$y17), max(pTotalHCVabD$y18), max(pTotalHCVabD$y19), max(pTotalHCVabD$y20), max(pTotalHCVabD$y21), max(pTotalHCVabD$y22), max(pTotalHCVabD$y23), max(pTotalHCVabD$y24), max(pTotalHCVabD$y25), max(pTotalHCVabD$y26), max(pTotalHCVabD$y27), max(pTotalHCVabD$y28), max(pTotalHCVabD$y29), max(pTotalHCVabD$y30))
HCVD$Year <- c("2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVD$Description <- c("DAA(optimistic) + HCV reduction(intermediate)")

HCVE <- data.frame("IncidenceIDU"=c(mean(pTotalHCVabE$y13), mean(pTotalHCVabE$y14), mean(pTotalHCVabE$y15), mean(pTotalHCVabE$y16), mean(pTotalHCVabE$y17), mean(pTotalHCVabE$y18), mean(pTotalHCVabE$y19), mean(pTotalHCVabE$y20), mean(pTotalHCVabE$y21), mean(pTotalHCVabE$y22), mean(pTotalHCVabE$y23), mean(pTotalHCVabE$y24), mean(pTotalHCVabE$y25), mean(pTotalHCVabE$y26), mean(pTotalHCVabE$y27), mean(pTotalHCVabE$y28), mean(pTotalHCVabE$y29), mean(pTotalHCVabE$y30)))
HCVE$IncidenceFloor <- c(min(pTotalHCVabE$y13), min(pTotalHCVabE$y14), min(pTotalHCVabE$y15), min(pTotalHCVabE$y16), min(pTotalHCVabE$y17), min(pTotalHCVabE$y18), min(pTotalHCVabE$y19), min(pTotalHCVabE$y20), min(pTotalHCVabE$y21), min(pTotalHCVabE$y22), min(pTotalHCVabE$y23), min(pTotalHCVabE$y24), min(pTotalHCVabE$y25), min(pTotalHCVabE$y26), min(pTotalHCVabE$y27), min(pTotalHCVabE$y28), min(pTotalHCVabE$y29), min(pTotalHCVabE$y30))
HCVE$IncidenceCeiling <- c(max(pTotalHCVabE$y13), max(pTotalHCVabE$y14), max(pTotalHCVabE$y15), max(pTotalHCVabE$y16), max(pTotalHCVabE$y17), max(pTotalHCVabE$y18), max(pTotalHCVabE$y19), max(pTotalHCVabE$y20), max(pTotalHCVabE$y21), max(pTotalHCVabE$y22), max(pTotalHCVabE$y23), max(pTotalHCVabE$y24), max(pTotalHCVabE$y25), max(pTotalHCVabE$y26), max(pTotalHCVabE$y27), max(pTotalHCVabE$y28), max(pTotalHCVabE$y29), max(pTotalHCVabE$y30))
HCVE$Year <- c("2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVE$Description <- c("DAA(optimistic) + OST(intermediate) + Reduction(intermediate)")

HCVF <- data.frame("IncidenceIDU"=c(mean(pTotalHCVabF$y13), mean(pTotalHCVabF$y14), mean(pTotalHCVabF$y15), mean(pTotalHCVabF$y16), mean(pTotalHCVabF$y17), mean(pTotalHCVabF$y18), mean(pTotalHCVabF$y19), mean(pTotalHCVabF$y20), mean(pTotalHCVabF$y21), mean(pTotalHCVabF$y22), mean(pTotalHCVabF$y23), mean(pTotalHCVabF$y24), mean(pTotalHCVabF$y25), mean(pTotalHCVabF$y26), mean(pTotalHCVabF$y27), mean(pTotalHCVabF$y28), mean(pTotalHCVabF$y29), mean(pTotalHCVabF$y30)))
HCVF$IncidenceFloor <- c(min(pTotalHCVabF$y13), min(pTotalHCVabF$y14), min(pTotalHCVabF$y15), min(pTotalHCVabF$y16), min(pTotalHCVabF$y17), min(pTotalHCVabF$y18), min(pTotalHCVabF$y19), min(pTotalHCVabF$y20), min(pTotalHCVabF$y21), min(pTotalHCVabF$y22), min(pTotalHCVabF$y23), min(pTotalHCVabF$y24), min(pTotalHCVabF$y25), min(pTotalHCVabF$y26), min(pTotalHCVabF$y27), min(pTotalHCVabF$y28), min(pTotalHCVabF$y29), min(pTotalHCVabF$y30))
HCVF$IncidenceCeiling <- c(max(pTotalHCVabF$y13), max(pTotalHCVabF$y14), max(pTotalHCVabF$y15), max(pTotalHCVabF$y16), max(pTotalHCVabF$y17), max(pTotalHCVabF$y18), max(pTotalHCVabF$y19), max(pTotalHCVabF$y20), max(pTotalHCVabF$y21), max(pTotalHCVabF$y22), max(pTotalHCVabF$y23), max(pTotalHCVabF$y24), max(pTotalHCVabF$y25), max(pTotalHCVabF$y26), max(pTotalHCVabF$y27), max(pTotalHCVabF$y28), max(pTotalHCVabF$y29), max(pTotalHCVabF$y30))
HCVF$Year <- c("2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVF$Description <- c("DAA(optimistic) + OST(intermediate) + NSP(intermediate) + Reduction(intermediate)")

incHCVIDU <- rbind(HCVA, HCVB, HCVC, HCVD, HCVE, HCVF)
PlotC <- ggplot(data=incHCVIDU, aes(x=Year, y=IncidenceIDU, group=Description, col=Description, linetype=Description)) + geom_errorbar(aes(ymin=IncidenceFloor, ymax=IncidenceCeiling), width=.1) + geom_line(aes(linetype=Description, color=Description)) + geom_point(aes(shape=Description), size=3.5) + scale_linetype_manual(values=c("solid", "longdash", "twodash", "dotted", "dotdash", "solid")) + scale_shape_manual(values=c(16, 17, 18, 3, 21, 15)) + ylab("Average number of people with\n HCV Ab+") + geom_vline(xintercept=c(5), linetype="dotted") + scale_color_manual(values=c("coral", "chocolate", "cadetblue", "brown", "blue", "#006633")) + ylim(0, 10000) + ggtitle("C") + theme_bw() + theme(legend.position="right", text=element_text(size=19), legend.title=element_blank(), plot.title = element_text(hjust = -0.05, vjust=1), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.text.x = element_text(angle = 40, hjust = 1))
...
HCVD <- data.frame("IncidenceIDU"=c(mean(pTotalHCVRNAD$y13), mean(pTotalHCVRNAD$y14), mean(pTotalHCVRNAD$y15), mean(pTotalHCVRNAD$y16), mean(pTotalHCVRNAD$y17), mean(pTotalHCVRNAD$y18), mean(pTotalHCVRNAD$y19), mean(pTotalHCVRNAD$y20), mean(pTotalHCVRNAD$y21), mean(pTotalHCVRNAD$y22), mean(pTotalHCVRNAD$y23), mean(pTotalHCVRNAD$y24), mean(pTotalHCVRNAD$y25), mean(pTotalHCVRNAD$y26), mean(pTotalHCVRNAD$y27), mean(pTotalHCVRNAD$y28), mean(pTotalHCVRNAD$y29), mean(pTotalHCVRNAD$y30)))
HCVD$IncidenceFloor <- c(min(pTotalHCVRNAD$y13), min(pTotalHCVRNAD$y14), min(pTotalHCVRNAD$y15), min(pTotalHCVRNAD$y16), min(pTotalHCVRNAD$y17), min(pTotalHCVRNAD$y18), min(pTotalHCVRNAD$y19), min(pTotalHCVRNAD$y20), min(pTotalHCVRNAD$y21), min(pTotalHCVRNAD$y22), min(pTotalHCVRNAD$y23), min(pTotalHCVRNAD$y24), min(pTotalHCVRNAD$y25), min(pTotalHCVRNAD$y26), min(pTotalHCVRNAD$y27), min(pTotalHCVRNAD$y28), min(pTotalHCVRNAD$y29), min(pTotalHCVRNAD$y30))
HCVD$IncidenceCeiling <- c(max(pTotalHCVRNAD$y13), max(pTotalHCVRNAD$y14), max(pTotalHCVRNAD$y15), max(pTotalHCVRNAD$y16), max(pTotalHCVRNAD$y17), max(pTotalHCVRNAD$y18), max(pTotalHCVRNAD$y19), max(pTotalHCVRNAD$y20), max(pTotalHCVRNAD$y21), max(pTotalHCVRNAD$y22), max(pTotalHCVRNAD$y23), max(pTotalHCVRNAD$y24), max(pTotalHCVRNAD$y25), max(pTotalHCVRNAD$y26), max(pTotalHCVRNAD$y27), max(pTotalHCVRNAD$y28), max(pTotalHCVRNAD$y29), max(pTotalHCVRNAD$y30))
HCVD$Year <- c("2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVD$Description <- c("DAA(optimistic) + Reduction(intermediate)")

HCVE <- data.frame("IncidenceIDU"=c(mean(pTotalHCVRNAE$y13), mean(pTotalHCVRNAE$y14), mean(pTotalHCVRNAE$y15), mean(pTotalHCVRNAE$y16), mean(pTotalHCVRNAE$y17), mean(pTotalHCVRNAE$y18), mean(pTotalHCVRNAE$y19), mean(pTotalHCVRNAE$y20), mean(pTotalHCVRNAE$y21), mean(pTotalHCVRNAE$y22), mean(pTotalHCVRNAE$y23), mean(pTotalHCVRNAE$y24), mean(pTotalHCVRNAE$y25), mean(pTotalHCVRNAE$y26), mean(pTotalHCVRNAE$y27), mean(pTotalHCVRNAE$y28), mean(pTotalHCVRNAE$y29), mean(pTotalHCVRNAE$y30)))
HCVE$IncidenceFloor <- c(min(pTotalHCVRNAE$y13), min(pTotalHCVRNAE$y14), min(pTotalHCVRNAE$y15), min(pTotalHCVRNAE$y16), min(pTotalHCVRNAE$y17), min(pTotalHCVRNAE$y18), min(pTotalHCVRNAE$y19), min(pTotalHCVRNAE$y20), min(pTotalHCVRNAE$y21), min(pTotalHCVRNAE$y22), min(pTotalHCVRNAE$y23), min(pTotalHCVRNAE$y24), min(pTotalHCVRNAE$y25), min(pTotalHCVRNAE$y26), min(pTotalHCVRNAE$y27), min(pTotalHCVRNAE$y28), min(pTotalHCVRNAE$y29), min(pTotalHCVRNAE$y30))
HCVE$IncidenceCeiling <- c(max(pTotalHCVRNAE$y13), max(pTotalHCVRNAE$y14), max(pTotalHCVRNAE$y15), max(pTotalHCVRNAE$y16), max(pTotalHCVRNAE$y17), max(pTotalHCVRNAE$y18), max(pTotalHCVRNAE$y19), max(pTotalHCVRNAE$y20), max(pTotalHCVRNAE$y21), max(pTotalHCVRNAE$y22), max(pTotalHCVRNAE$y23), max(pTotalHCVRNAE$y24), max(pTotalHCVRNAE$y25), max(pTotalHCVRNAE$y26), max(pTotalHCVRNAE$y27), max(pTotalHCVRNAE$y28), max(pTotalHCVRNAE$y29), max(pTotalHCVRNAE$y30))
HCVE$Year <- c("2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVE$Description <- c("DAA(optimistic) + OST(intermediate) + Reduction(intermediate)")

HCVF <- data.frame("IncidenceIDU"=c(mean(pTotalHCVRNAF$y13), mean(pTotalHCVRNAF$y14), mean(pTotalHCVRNAF$y15), mean(pTotalHCVRNAF$y16), mean(pTotalHCVRNAF$y17), mean(pTotalHCVRNAF$y18), mean(pTotalHCVRNAF$y19), mean(pTotalHCVRNAF$y20), mean(pTotalHCVRNAF$y21), mean(pTotalHCVRNAF$y22), mean(pTotalHCVRNAF$y23), mean(pTotalHCVRNAF$y24), mean(pTotalHCVRNAF$y25), mean(pTotalHCVRNAF$y26), mean(pTotalHCVRNAF$y27), mean(pTotalHCVRNAF$y28), mean(pTotalHCVRNAF$y29), mean(pTotalHCVRNAF$y30)))
HCVF$IncidenceFloor <- c(min(pTotalHCVRNAF$y13), min(pTotalHCVRNAF$y14), min(pTotalHCVRNAF$y15), min(pTotalHCVRNAF$y16), min(pTotalHCVRNAF$y17), min(pTotalHCVRNAF$y18), min(pTotalHCVRNAF$y19), min(pTotalHCVRNAF$y20), min(pTotalHCVRNAF$y21), min(pTotalHCVRNAF$y22), min(pTotalHCVRNAF$y23), min(pTotalHCVRNAF$y24), min(pTotalHCVRNAF$y25), min(pTotalHCVRNAF$y26), min(pTotalHCVRNAF$y27), min(pTotalHCVRNAF$y28), min(pTotalHCVRNAF$y29), min(pTotalHCVRNAF$y30))
HCVF$IncidenceCeiling <- c(max(pTotalHCVRNAF$y13), max(pTotalHCVRNAF$y14), max(pTotalHCVRNAF$y15), max(pTotalHCVRNAF$y16), max(pTotalHCVRNAF$y17), max(pTotalHCVRNAF$y18), max(pTotalHCVRNAF$y19), max(pTotalHCVRNAF$y20), max(pTotalHCVRNAF$y21), max(pTotalHCVRNAF$y22), max(pTotalHCVRNAF$y23), max(pTotalHCVRNAF$y24), max(pTotalHCVRNAF$y25), max(pTotalHCVRNAF$y26), max(pTotalHCVRNAF$y27), max(pTotalHCVRNAF$y28), max(pTotalHCVRNAF$y29), max(pTotalHCVRNAF$y30))
HCVF$Year <- c("2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030")
HCVF$Description <- c("DAA(optimistic) + OST(intermediate) + NSP(intermediate) + Reduction(intermediate)")

incHCVIDU <- rbind(HCVA, HCVB, HCVC, HCVD, HCVE, HCVF)
PlotD <- ggplot(data=incHCVIDU, aes(x=Year, y=IncidenceIDU, group=Description, col=Description, linetype=Description)) + geom_errorbar(aes(ymin=IncidenceFloor, ymax=IncidenceCeiling), width=.1) + geom_line(aes(linetype=Description, color=Description)) + geom_point(aes(shape=Description), size=3.5) + scale_linetype_manual(values=c("solid", "longdash", "twodash", "dotted", "dotdash", "solid")) + scale_shape_manual(values=c(16, 17, 18, 3, 21, 15)) + ylab("Average number of people with\n HCV RNA+") + geom_vline(xintercept=c(5), linetype="dotted") + scale_color_manual(values=c("coral", "chocolate", "cadetblue", "brown", "blue", "#006633")) + ylim(0, 10000) + ggtitle("D") + theme_bw() + theme(legend.position="right", text=element_text(size=19), legend.title=element_blank(), plot.title = element_text(hjust = -0.05, vjust=1), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.text.x = element_text(angle = 40, hjust = 1))

legend1 <- get_legend(PlotLegend1)
legend2 <- get_legend(PlotLegend2)
grid.newpage()
#grid.arrange(arrangeGrob(PlotA, PlotB))
#popPlots <- rbind (ggplotGrob(PlotA), ggplotGrob(PlotB), size="first")
ggdraw() + draw_plot(plot_grid(PlotA + theme(legend.position='none'), PlotB + theme(legend.position='none'), PlotC + theme(legend.position='none'), PlotD + theme(legend.position='none'), ncol=2, nrow=2, align='hv'), width=0.9) + draw_plot(legend1, x=0.72, y=0.67, width=0.1, height=0.5) + draw_plot(legend2, x=0.65, y=0.17, width=0.1, height=0.5)
