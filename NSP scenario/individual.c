...
void newIndiv (int *idGlobal, int *HCVentry, int *HCVentryAb, int currDay, sIndiv **pHeadCopy, sIndiv **pTailCopy, gsl_rng **r, int nEvents, int (*pLocArray2)[ROWPRIS][COLCTR], int prison, int category){
    ...
    if(prison==99){ //random injector from community to be converted into individual
        ...
        rMin=gsl_ran_exponential(*r, 0.000911111);
        probsMove[1]=rMin;
        //lb=0.000475;
        //ub=0.000733333;
        ...
        rMed=gsl_ran_exponential(*r, 0.000850278);
        probsMove[2]=rMed;
        //lb=0.00085;
        //ub=0.001144444;
        ...
        rMax=gsl_ran_exponential(*r, 0.000719167);
        probsMove[3]=rMax;
...
double probStopInj(gsl_rng **r, sIndiv **pTarget){ //Probability to change risk group
    ...
    if(current->OST==2){ //under OST, return 0
        ...
        if(current->risk==1){//injecting less daily, opioid, no sharing
            ...
            //return 2.93409E-05;
            //return 4.77E-06;
            return 0.002009895*pChange;//5.50656E-06;
            ...
            //return 0.000104527;
            //return 0.000128695;
            return 0.001054254*pChange;//2.88837E-06;
            ...
            //return 4.95128E-05;
            //return 1.43E-05;
            return 0.003284843*pChange;//8.99957E-06;
            ...
            //return 2.75071E-05;
            //return 9.53E-06;
            return 0.002003473*pChange;//5.48897E-06;
            ...
            //return 2.38395E-05;
            //return 0;
            return 0.001782042*pChange;//4.88231E-06;
            ...
            //return 6.6017E-05;
            //return 4.29E-05;
            return 0.002455938*pChange;//6.7286E-06;
            ...
            //return 2.01719E-05;
            //return 0.0;
            return 0.004616477*pChange;//1.26479E-05;
            ...
            //return 0.0;
            //return 0.0;
            return 0.000268528*pChange;//7.35694E-07;
            ...
            //return 0.001006759;
            //return 0.000776938;
            return 0.002752032*pChange;//7.53981E-06;
    }else{
        if(current->risk==1){//injecting less daily, opioid, no sharing
            //return gsl_ran_beta(*r, 1.502713, 37472.63);
            //return gsl_ran_poisson_pdf(1, gsl_ran_flat(*r, 1.68E-05, 4.76E-05));
...
double probInjLdOpShLd(gsl_rng **r, sIndiv **pTarget){ //Probability to change risk group
    ...
    if(current->OST==1&&current->OST==2){ //under OST, return 0
        return 0.0;
    }else if(current->NSP==1){ //under NSP, return 0
        return 0.0;
    }else{
        if(current->risk==0){//non-injecting
            //return gsl_ran_beta(*r, 4.971834, 91557.35);
...
double probInjLdNoNoSh(gsl_rng **r, sIndiv **pTarget){ //Probability to change risk group
    ...
    if(current->OST==2){ //under OST, return 0
        ...
        if(current->risk==0){//non-injecting
            ...
            //return 1.28366E-05;
            //return 9.53E-06;
            return 8.10964E-05*pChange;//2.22182E-07;
        }else if(current->risk==3){//injecting less daily, opioid, sharing daily more
            return 0.0;
        }else if(current->risk==5){//injecting less daily, non-opioid, sharing less daily
            //return gsl_ran_beta(*r, 0.8171718, 141869.3);
            ...
            //return 7.33522E-06;
            //return 1.43E-05;
            return 0.000534259*pChange;//1.46372E-06;
        }else if(current->risk==6){//injecting less daily, non-opioid, sharing daily more
            return 0.0;
        }else if(current->risk==7){//injecting daily more, opioid, no sharing
            //return gsl_ran_beta(*r, 0.9470623, 144588.7);
            ...
            //return 5.50142E-06;
            //return 0.0;
            return 0.000433401*pChange;//1.1874E-06;
        }else if(current->risk==9){//injecting daily more, opioid, sharing daily more
            return 0.0;
        }else if(current->risk==10){//injecting daily more, non-opioid, no sharing
            //return gsl_ran_beta(*r, 2.3502, 560904.6);
            ...
            //return 1.46704E-05;
            //return 0.0;
            return 0.000351947*pChange;//9.6424E-07;
    }else{
        if(current->risk==0){//non-injecting
            //return gsl_ran_beta(*r, 4.971834, 91557.35);
            //return gsl_ran_poisson (*r, 8.06875E-05);
...
double probInjLdNoShLd(gsl_rng **r, sIndiv **pTarget){ //Probability to change risk group
    ...
    if(current->NSP==1){ //under NSP, return 0
        return 0.0;
    }else if(current->OST==1){ //under OST, return 0
        if(current->risk==0){//non-injecting
            //return gsl_ran_beta(*r, 4.971834, 91557.35);
            //return gsl_ran_poisson (*r, 4.03437E-05);
            //return 4.03437E-05;
            //return 5.72E-05;
            return 8.16121E-05*.11;//2.23595E-07;//2.23595E-07;
        }else if(current->risk==1){//injecting less daily, opioid, no sharing
            //return gsl_ran_beta(*r, 0.9470623, 144588.7);
            //return gsl_ran_poisson (*r, 3.66761E-06);
            //return 3.66761E-06;
            //return 0.0;
            return 0.000309215*.11;//8.47163E-07;
        }else if(current->risk==2){//injecting less daily, opioid, sharing less daily
            //return gsl_ran_beta(*r, 0.8074784, 49843.54);
            //return gsl_ran_poisson (*r, 2.20057E-05);
            //return 2.20057E-05;
            //return 1.91E-05;
            return 0.000486579*.11;//1.33309E-06;
        }else if(current->risk==3){//injecting less daily, opioid, sharing daily more
            return 0.0;
            ...
            //return 3.66761E-06;
            //return 0.0;
            return 0.000234632*.11;//6.42826E-07;
        }else if(current->risk==6){//injecting less daily, non-opioid, sharing daily more
            return 0.0;
        }else if(current->risk==7){//injecting daily more, opioid, no sharing
            //return gsl_ran_beta(*r, 0.9470623, 144588.7);
            //return 0.0;
            //return 0.0;
            return 0.000548321*.11;//1.50225E-06;
        }else if(current->risk==8){//injecting daily more, opioid, sharing less daily
            //return gsl_ran_beta(*r, 0.8074784, 49843.54);
            //return gsl_ran_poisson (*r, 9.16903E-06);
            //return 9.16903E-06;
            //return 1.43E-05;
            return 0.000288934*.11;//7.916E-07;
        }else if(current->risk==9){//injecting daily more, opioid, sharing daily more
            return 0.0;
        }else if(current->risk==10){//injecting daily more, non-opioid, no sharing
            //return gsl_ran_beta(*r, 2.3502, 560904.6);
            ...
            //return 5.50142E-06;
            //return 0.0;
            return 0.000355114*.11;//9.72914E-07;
        }else if(current->risk==11){//injecting daily more, non-opioid, sharing less daily
            //return gsl_ran_beta(*r, 0.8171718, 141869.3);
            //return 0.0;
            //return 0.0;
            return 0.000805585*.11;//7.35694E-07;
        }else if(current->risk==12){//injecting daily more, non-opioid, sharing daily more
            return 0.0;
            ...
            //return 1.83381E-05;
            //return 9.53E-06;
            return 0.001469213*.11;//4.02524E-06;
    }else{
        if(current->risk==0){//non-injecting
            //return gsl_ran_beta(*r, 4.971834, 91557.35);
            //return gsl_ran_poisson (*r, 4.03437E-05);
...
double probInjDmNoNoSh(gsl_rng **r, sIndiv **pTarget){ //Probability to change risk group
    ...
    if(current->OST==1){ //under OST, return 0
        if(current->risk==0){//non-injecting
            ...
            //return 1.83381E-06;
            //return 0.0;
            return 0.000117316*0.035;//3.21413E-07;
        }else if(current->risk==5){//injecting less daily, non-opioid, sharing less daily
            //return gsl_ran_beta(*r, 0.8171718, 141869.3);
            //return gsl_ran_poisson (*r, 7.33522E-06);
            //return 7.33522E-06;
            ...
            //return 1.83381E-06;
            //return 0.0;
            return 0.000268528*0.035;//7.35694E-07;
        }else if(current->risk==12){//injecting daily more, non-opioid, sharing daily more
            return 0.0;
            ...
            //return 1.10028E-05;
            //return 4.77E-06;
            return 0.000355114*0.035;//9.72914E-07;
        ...
        if(current->risk==0){//non-injecting
            ...
            //return 1.83381E-06;
            //return 0.0;
            return 0.000117316*pChange;//3.21413E-07;
        }else if(current->risk==5){//injecting less daily, non-opioid, sharing less daily
            //return gsl_ran_beta(*r, 0.8171718, 141869.3);
            //return gsl_ran_poisson (*r, 7.33522E-06);
            //return 7.33522E-06;
            ...
            //return 1.10028E-05;
            //return 4.77E-06;
            return 0.000355114*pChange;//9.72914E-07;
    }else{
        if(current->risk==0){//non-injecting
            //return gsl_ran_beta(*r, 4.971834, 91557.35);
            //return gsl_ran_poisson (*r, 4.7679E-05);
...
double probInjDmNoShLd(gsl_rng **r, sIndiv **pTarget){ //Probability to change risk group
    ...
    if(current->NSP==1){ //under NSP, return 0
        ...
        if(current->risk==0){//non-injecting
            ...
            //return 7.33522E-06;
            //return 4.77E-06;
            return 1.3602E-05*0.145;//3.72658E-08;//3.72658E-08;
        }else if(current->risk==1){//injecting less daily, opioid, no sharing
            //return gsl_ran_beta(*r, 0.9470623, 144588.7);
            //return 0.0;
            //return 0.0;
            ...
            //return 7.33522E-06;
            //return 9.53E-06;
            return 8.10964E-05*0.145;//2.22182E-07;
        }else if(current->risk==3){//injecting less daily, opioid, sharing daily more
            return 0.0;
        }else if(current->risk==4){//injecting less daily, non-opioid, sharing no sharing
            //return gsl_ran_beta(*r, 2.3502, 560904.6);
            ...
            //return 1.83381E-06;
            //return 0.0;
            return 0.000117316*0.145;//3.21413E-07;
        }else if(current->risk==5){//injecting less daily, non-opioid, sharing less daily
            //return gsl_ran_beta(*r, 0.8171718, 141869.3);
            //return gsl_ran_beta(*r, , );
            //return gsl_ran_poisson (*r, 1.83381E-05);
            //return 1.83381E-05;
            //return 9.53E-06;
            return 0.000400695*0.145;//1.09779E-06;
        }else if(current->risk==6){//injecting less daily, non-opioid, sharing daily more
            return 0.0;
        }else if(current->risk==7){//injecting daily more, opioid, no sharing
            //return gsl_ran_beta(*r, 0.9470623, 144588.7);
            ...
            //return 1.83381E-06;
            //return 0.0;
            return 0.00027416*0.145;//7.51124E-07;
        }else if(current->risk==8){//injecting daily more, opioid, sharing less daily
            //return gsl_ran_beta(*r, 0.8074784, 49843.54);
            //return gsl_ran_beta(*r, , );
            //return gsl_ran_poisson (*r, 1.83381E-06);
            //return 1.83381E-06;
            //return 0.0;
            return 0.000433401*0.145;//1.1874E-06;
        }else if(current->risk==9){//injecting daily more, opioid, sharing daily more
            return 0.0;
        }else if(current->risk==10){//injecting daily more, non-opioid, no sharing
            //return gsl_ran_beta(*r, 2.3502, 560904.6);
            ...
            //return 0.0;
            //return 0.0;
            return 0.001074114*0.145;//2.94278E-06;
    }else{
        if(current->risk==0){//non-injecting
            //return gsl_ran_beta(*r, 4.971834, 91557.35);
            //return gsl_ran_poisson (*r, 7.33522E-06);
...
double probInfectIndiv(sIndiv **pTarget, int currDay){ //PROBABILITY OF SHARING
    sIndiv *current;
    current=*pTarget;
...
double probDAAclear(gsl_rng **r, sIndiv **pTarget, int currDay){ //Probability to clear HCV via DAA (only if infected)
    ...
    if(current->DAA==1){ //infected and is on DAA
        ...
        // 12 weeks=84 days
            ...
            if(deltaWeeks<12){
                return 7.92*deltaWeeks; //7.92 from 95% clearance in 12-week regimen (Martin, NK, et al.)
            }else
                return 0.0;
        }else //not infected
            return 0.0;
...
double probNSPstart(gsl_rng **r, sIndiv **pTarget, int nNSP, int currDay, int nDailyNSP, int nNSPDailyCap){ //Probability to start DAA therapy (only if infected)
    ...
    if(nNSP>0){
        if(nDailyNSP<nNSPDailyCap){
            if(current->NSP==0){
                if(current->risk>0){ //injecting
                    return 1.0; //200/730
                }else //not injecting
                    return 0.0;
            }else
                return 0.0;
        }else if(nDailyNSP>=nNSPDailyCap)
            return 0.0;
    }else //no more DAA
        return 0.0;
}
...
int infect(gsl_rng **r, int nEvents, sIndiv **pTargetCopy, sIndiv **pHeadCopy, sIndiv **pTailCopy, int (*pLocArray2)[ROWPRIS][COLCTR], int currDay){
    ...
    /*
        ...
        */
         ...
         probInf[1]=gsl_ran_exponential(*r, 0.0083); //perEvent probability
         probInf[0]=1-probInf[1];
         eInf=draw_multinom(&rCopy, 2, probInf);
