...
int main(int argc, const char * argv[])
{
    ...
    int nOST=0, nDAA=0, nReinfected, inIncrease, nDailyOST=0, nDaily=0, nOSTDailyCap=0, nDailyCap=0, dailyInPop=0, hcvAntibody=0, hcvRNA=0, aveLengthStay=0;
	gsl_rng *r;
...
*/            
        ...
        fprintf(fw, "%d\n", aveLengthStay); //number of those infected with HCV upon entry
        printf("DAYS:                %d\n", currDay);
        newCases=0;
