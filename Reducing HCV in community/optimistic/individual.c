                ...
                if(binATSI==1){
                    ...
                    if(binHCV==1){ //IDU ATSI HCV
                        ...
                        if(currDay<4381){
                            ...
                            probsRisk[0]=1-0.625788936;//1-0.80; //viraemic
                            probsRisk[1]=0.625788936;//0.80; //previously exposed
                        }else if(currDay>4745&&currDay<5111){ //2019
                            probsRisk[0]=1-0.500356179;//1-0.80; //viraemic
                            probsRisk[1]=0.500356179;//0.80; //previously exposed
                        }else if(currDay>5110&&currDay<5476){ //2020
                            probsRisk[0]=1-0.384070876;//1-0.80; //viraemic
                            probsRisk[1]=0.384070876;//0.80; //previously exposed
                        }else if(currDay>5475&&currDay<5841){ //2021
                            probsRisk[0]=1-0.284967097;//1-0.80; //viraemic
                            probsRisk[1]=0.284967097;//0.80; //previously exposed
                        }else if(currDay>5840&&currDay<6206){ //2022
                            probsRisk[0]=1-0.202587373;//1-0.80; //viraemic
                            probsRisk[1]=0.202587373;//0.80; //previously exposed
                        }else if(currDay>6205&&currDay<6571){ //2023
                            probsRisk[0]=1-0.139539315;//1-0.80; //viraemic
                            probsRisk[1]=0.139539315;//0.80; //previously exposed
                        }else if(currDay>6570&&currDay<6936){ //2024
                            probsRisk[0]=1-0.106323934;//1-0.80; //viraemic
                            probsRisk[1]=0.106323934;//0.80; //previously exposed
                        }else if(currDay>6935&&currDay<7301){ //2025
                            probsRisk[0]=1-0.0786;//1-0.80; //viraemic
                            probsRisk[1]=0.0786;//0.80; //previously exposed
                        }else if(currDay>7300&&currDay<7666){ //2026
                            probsRisk[0]=1-0.050766105;//1-0.80; //viraemic
                            probsRisk[1]=0.050766105;//0.80; //previously exposed
                        }else if(currDay>7665&&currDay<8031){ //2027
                            probsRisk[0]=1-0.022581718;//1-0.80; //viraemic
                            probsRisk[1]=0.022581718;//0.80; //previously exposed
                        }else if(currDay>8030&&currDay<8396){ //2028
                            probsRisk[0]=1-0.003470615;//1-0.80; //viraemic
                            probsRisk[1]=0.003470615;//0.80; //previously exposed
                        }else if(currDay>8395&&currDay<8761){ //2029
                            probsRisk[0]=1-0.001239086;//1-0.80; //viraemic
                            probsRisk[1]=0.001239086;//0.80; //previously exposed
                        }else{ //if(currDay>8760&&currDay<9125){ //2030
                            probsRisk[0]=1-0.000572362;//1-0.80; //viraemic
                            probsRisk[1]=0.000572362;//0.80; //previously exposed
                        }
...
double probInfectIndiv(sIndiv **pTarget, int currDay){ //PROBABILITY OF SHARING
    ...
    //if(current->metavir<5){ //if infected with chronic HCV, can infect others
        ...
        if(current->risk==2||current->risk==5){ //IDU LD
            ...
            return 0.154375;//0.159375;//0.044375;
